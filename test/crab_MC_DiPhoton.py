...
config = config()
config.General.requestName = 'b2gtreeV5_DiPhotonJets_MGG_80ToInf_13TeV_amcatnloFXFX_Pythia8'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'run_B2GTTbarTreeMaker_MC_CRAB_DiPhotonJets.py'
config.JobType.maxJobRuntimeMin = 2750
config.Data.inputDataset ='/DiPhotonJets_MGG-80toInf_13TeV_amcatnloFXFX_pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM' #'/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
...
os.environ['CMSSW_BASE'] + '/config/toolbox/slc6_amd64_gcc530/tools/selected/fastjet-contrib.xml'


]
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 1
config.Data.outLFNDirBase = '/store/user/asparker/B2G2016/V5TTreesNew/'
