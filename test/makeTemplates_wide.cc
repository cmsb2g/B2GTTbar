...
int makeTemplates(bool ZPNflag, bool ZPWflag, bool ZPXWflag, bool RSGflag){
	...
	files[names::ZPN10] = dir1 +  "outBkgdEst_ZprimeToTT_M-1000_W-100_B2Gv8p4_reader603e_011516_nom.root";
	files[names::ZPN15] = dir1 +  "outBkgdEst_ZprimeToTT_M-1500_W-150_B2Gv8p4_reader603e_011516_nom.root";
	files[names::ZPN20] = dir1 +  "outBkgdEst_ZprimeToTT_M-2000_W-200_B2Gv8p4_reader603e_011516_nom.root";
	files[names::ZPN25] = dir1 +  "outBkgdEst_ZprimeToTT_M-2500_W-250_B2Gv8p4_reader603e_011516_nom.root";
	files[names::ZPN30] = dir1 +  "outBkgdEst_ZprimeToTT_M-3000_W-300_B2Gv8p4_reader603e_011516_nom.root";
	files[names::ZPN35] = dir1 +  "outBkgdEst_ZprimeToTT_M-3500_W-350_B2Gv8p4_reader603e_011516_nom.root";
	files[names::ZPN40] = dir1 +  "outBkgdEst_ZprimeToTT_M-4000_W-400_B2Gv8p4_reader603e_011516_nom.root";
	files[names::ZPN10_SCALEUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-1000_W-100_B2Gv8p4_reader603e_011516_jec_up.root";
	files[names::ZPN15_SCALEUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-1500_W-150_B2Gv8p4_reader603e_011516_jec_up.root";
	files[names::ZPN20_SCALEUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-2000_W-200_B2Gv8p4_reader603e_011516_jec_up.root";
	files[names::ZPN25_SCALEUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-2500_W-250_B2Gv8p4_reader603e_011516_jec_up.root";
	files[names::ZPN30_SCALEUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-3000_W-300_B2Gv8p4_reader603e_011516_jec_up.root";
	files[names::ZPN35_SCALEUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-3500_W-350_B2Gv8p4_reader603e_011516_jec_up.root";
	files[names::ZPN40_SCALEUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-4000_W-400_B2Gv8p4_reader603e_011516_jec_up.root";
	files[names::ZPN10_SCALEDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-1000_W-100_B2Gv8p4_reader603e_011516_jec_dn.root";
	files[names::ZPN15_SCALEDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-1500_W-150_B2Gv8p4_reader603e_011516_jec_dn.root";
	files[names::ZPN20_SCALEDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-2000_W-200_B2Gv8p4_reader603e_011516_jec_dn.root";
	files[names::ZPN25_SCALEDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-2500_W-250_B2Gv8p4_reader603e_011516_jec_dn.root";
	files[names::ZPN30_SCALEDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-3000_W-300_B2Gv8p4_reader603e_011516_jec_dn.root";
	files[names::ZPN35_SCALEDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-3500_W-350_B2Gv8p4_reader603e_011516_jec_dn.root";
	files[names::ZPN40_SCALEDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-4000_W-400_B2Gv8p4_reader603e_011516_jec_dn.root";
	files[names::ZPN10_JERUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-1000_W-100_B2Gv8p4_reader603e_011516_jer_up.root";
	files[names::ZPN15_JERUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-1500_W-150_B2Gv8p4_reader603e_011516_jer_up.root";
	files[names::ZPN20_JERUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-2000_W-200_B2Gv8p4_reader603e_011516_jer_up.root";
	files[names::ZPN25_JERUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-2500_W-250_B2Gv8p4_reader603e_011516_jer_up.root";
	files[names::ZPN30_JERUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-3000_W-300_B2Gv8p4_reader603e_011516_jer_up.root";
	files[names::ZPN35_JERUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-3500_W-350_B2Gv8p4_reader603e_011516_jer_up.root";
	files[names::ZPN40_JERUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-4000_W-400_B2Gv8p4_reader603e_011516_jer_up.root";
	files[names::ZPN10_JERDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-1000_W-100_B2Gv8p4_reader603e_011516_jer_dn.root";
	files[names::ZPN15_JERDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-1500_W-150_B2Gv8p4_reader603e_011516_jer_dn.root";
	files[names::ZPN20_JERDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-2000_W-200_B2Gv8p4_reader603e_011516_jer_dn.root";
	files[names::ZPN25_JERDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-2500_W-250_B2Gv8p4_reader603e_011516_jer_dn.root";
	files[names::ZPN30_JERDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-3000_W-300_B2Gv8p4_reader603e_011516_jer_dn.root";
	files[names::ZPN35_JERDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-3500_W-350_B2Gv8p4_reader603e_011516_jer_dn.root";
	files[names::ZPN40_JERDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-4000_W-400_B2Gv8p4_reader603e_011516_jer_dn.root";
	files[names::ZPN10_BTAGUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-1000_W-100_B2Gv8p4_reader603e_011516_bTag_up.root";
	files[names::ZPN15_BTAGUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-1500_W-150_B2Gv8p4_reader603e_011516_bTag_up.root";
	files[names::ZPN20_BTAGUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-2000_W-200_B2Gv8p4_reader603e_011516_bTag_up.root";
	files[names::ZPN25_BTAGUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-2500_W-250_B2Gv8p4_reader603e_011516_bTag_up.root";
	files[names::ZPN30_BTAGUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-3000_W-300_B2Gv8p4_reader603e_011516_bTag_up.root";
	files[names::ZPN35_BTAGUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-3500_W-350_B2Gv8p4_reader603e_011516_bTag_up.root";
	files[names::ZPN40_BTAGUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-4000_W-400_B2Gv8p4_reader603e_011516_bTag_up.root";
	files[names::ZPN10_BTAGDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-1000_W-100_B2Gv8p4_reader603e_011516_bTag_dn.root";
	files[names::ZPN15_BTAGDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-1500_W-150_B2Gv8p4_reader603e_011516_bTag_dn.root";
	files[names::ZPN20_BTAGDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-2000_W-200_B2Gv8p4_reader603e_011516_bTag_dn.root";
	files[names::ZPN25_BTAGDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-2500_W-250_B2Gv8p4_reader603e_011516_bTag_dn.root";
	files[names::ZPN30_BTAGDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-3000_W-300_B2Gv8p4_reader603e_011516_bTag_dn.root";
	files[names::ZPN35_BTAGDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-3500_W-350_B2Gv8p4_reader603e_011516_bTag_dn.root";
	files[names::ZPN40_BTAGDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-4000_W-400_B2Gv8p4_reader603e_011516_bTag_dn.root";
	files[names::ZPN10_PDFUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-1000_W-100_B2Gv8p4_reader603e_011516_pdf_up.root";
	files[names::ZPN15_PDFUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-1500_W-150_B2Gv8p4_reader603e_011516_pdf_up.root";
	files[names::ZPN20_PDFUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-2000_W-200_B2Gv8p4_reader603e_011516_pdf_up.root";
	files[names::ZPN25_PDFUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-2500_W-250_B2Gv8p4_reader603e_011516_pdf_up.root";
	files[names::ZPN30_PDFUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-3000_W-300_B2Gv8p4_reader603e_011516_pdf_up.root";
	files[names::ZPN35_PDFUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-3500_W-350_B2Gv8p4_reader603e_011516_pdf_up.root";
	files[names::ZPN40_PDFUP] = dir1 +  "outBkgdEst_ZprimeToTT_M-4000_W-400_B2Gv8p4_reader603e_011516_pdf_up.root";
	files[names::ZPN10_PDFDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-1000_W-100_B2Gv8p4_reader603e_011516_pdf_dn.root";
	files[names::ZPN15_PDFDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-1500_W-150_B2Gv8p4_reader603e_011516_pdf_dn.root";
	files[names::ZPN20_PDFDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-2000_W-200_B2Gv8p4_reader603e_011516_pdf_dn.root";
	files[names::ZPN25_PDFDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-2500_W-250_B2Gv8p4_reader603e_011516_pdf_dn.root";
	files[names::ZPN30_PDFDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-3000_W-300_B2Gv8p4_reader603e_011516_pdf_dn.root";
	files[names::ZPN35_PDFDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-3500_W-350_B2Gv8p4_reader603e_011516_pdf_dn.root";
	files[names::ZPN40_PDFDN] = dir1 +  "outBkgdEst_ZprimeToTT_M-4000_W-400_B2Gv8p4_reader603e_011516_pdf_dn.root";
	...
	for (int tag = 0; tag < nTagCats; tag++){
		...
		histos[names::ZPN10][tag]->Scale( 1. * lumi / 124293. ); 
		...
		histos[names::ZPN10_SCALEUP][tag]->Scale( 1. * lumi / 124293. ); 
		...
		histos[names::ZPN10_SCALEDN][tag]->Scale( 1. * lumi / 124293. ); 
		...
		histos[names::ZPN10_JERUP][tag]->Scale( 1. * lumi / 124293. ); 
		...
		histos[names::ZPN10_JERDN][tag]->Scale( 1. * lumi / 124293. ); 
		...
		histos[names::ZPN10_BTAGUP][tag]->Scale( 1. * lumi / 124293. ); 
		histos[names::ZPN15_BTAGUP][tag]->Scale( 1. * lumi / 110747. ); 
		histos[names::ZPN20_BTAGUP][tag]->Scale( 1. * lumi / 103854. ); 
		histos[names::ZPN25_BTAGUP][tag]->Scale( 1. * lumi / 118093. ); 
		histos[names::ZPN30_BTAGUP][tag]->Scale( 1. * lumi / 246767. ); 
		histos[names::ZPN35_BTAGUP][tag]->Scale( 1. * lumi / 126158. );
		histos[names::ZPN40_BTAGUP][tag]->Scale( 1. * lumi / 126264. );
		histos[names::ZPN10_BTAGDN][tag]->Scale( 1. * lumi / 124293. ); 
		histos[names::ZPN15_BTAGDN][tag]->Scale( 1. * lumi / 110747. ); 
		histos[names::ZPN20_BTAGDN][tag]->Scale( 1. * lumi / 103854. ); 
		histos[names::ZPN25_BTAGDN][tag]->Scale( 1. * lumi / 118093. ); 
		histos[names::ZPN30_BTAGDN][tag]->Scale( 1. * lumi / 246767. ); 
		histos[names::ZPN35_BTAGDN][tag]->Scale( 1. * lumi / 126158. );
		histos[names::ZPN40_BTAGDN][tag]->Scale( 1. * lumi / 126264. );
		histos[names::ZPN10_PDFUP][tag]->Scale( 1. * lumi / 124293. ); 
		histos[names::ZPN15_PDFUP][tag]->Scale( 1. * lumi / 110747. ); 
		histos[names::ZPN20_PDFUP][tag]->Scale( 1. * lumi / 103854. ); 
		histos[names::ZPN25_PDFUP][tag]->Scale( 1. * lumi / 118093. ); 
		histos[names::ZPN30_PDFUP][tag]->Scale( 1. * lumi / 246767. ); 
		histos[names::ZPN35_PDFUP][tag]->Scale( 1. * lumi / 126158. );
		histos[names::ZPN40_PDFUP][tag]->Scale( 1. * lumi / 126264. );
		histos[names::ZPN10_PDFDN][tag]->Scale( 1. * lumi / 124293. ); 
		histos[names::ZPN15_PDFDN][tag]->Scale( 1. * lumi / 110747. ); 
		histos[names::ZPN20_PDFDN][tag]->Scale( 1. * lumi / 103854. ); 
		histos[names::ZPN25_PDFDN][tag]->Scale( 1. * lumi / 118093. ); 
		histos[names::ZPN30_PDFDN][tag]->Scale( 1. * lumi / 246767. ); 
		histos[names::ZPN35_PDFDN][tag]->Scale( 1. * lumi / 126158. );
		histos[names::ZPN40_PDFDN][tag]->Scale( 1. * lumi / 126264. );
