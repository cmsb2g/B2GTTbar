...
theory->SetPoint(0, 1000, 1.3*3.48);
theory->SetPoint(1, 2000, 1.3*0.178);
theory->SetPoint(2, 3000, 1.3*0.0193);
theory->SetPoint(3, 4000, 1.3*0.00266);
