...
int makeTemplates_extrawide(bool constantBinning = 0){
  ...
  string file = "templates_extrawide.root";
  if (constantBinning) file = "templates_extrawide_constantBinning.root";
