...
hists_names.push_back("h_AntiTagTau32_ReqTopMassSD_TagMassSDTau32_jetP_dRapLo_2btag");       
    ...
    TFile * OutFile = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_300toInf_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root" , "RECREATE");
	
	TFile * fQCD1  = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_300to470_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root"   );
	TFile * fQCD2  = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_470to600_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root"   );
	TFile * fQCD3  = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_600to800_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root"   );
	TFile * fQCD4  = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_800to1000_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root"  );
	TFile * fQCD5  = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_1000to1400_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root" );
	TFile * fQCD6  = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_1400to1800_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root" );
	TFile * fQCD7  = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_1800to2400_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root" );
	TFile * fQCD8  = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_2400to3200_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root" );
	TFile * fQCD9  = new TFile("histsAllHad_Sept19_b2gtree_QCD_Pt_3200toInf_pythia8_RunIISpring16MiniAODv2_reHLT_V2.root"  );
	...
	for (unsigned int i=0; i< hists_names.size(); i++ ){
		...
		// h1->Draw();
		// h2->Draw("same");
		string savename = "testStack_"+hists_names[i]+".pdf";
		string savename2 = "testStack_"+hists_names[i]+"_log.pdf";
