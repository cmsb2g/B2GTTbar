...
void plotter(TString, TString, TString, bool, TH1D*, TH1D*, TH1D*, TH1D*, TH1D*, TH1D*, TH1D*, bool, double, double);
...
cout<<"hhZp40 "<<hhZp40->Integral()<<endl;
		...
		// else{
		    ...
		    plotter(combo_hist_label[i], hists_title[i], pave[i], paveSplitLine[i], h2Data, h2TT, h2QCD, h2Zp10, h2Zp20, h2Zp30, h2Zp40, legs[i], x_max_scale[i], y_max_scale[i] );
		    plotter(combo_hist_label2[i], hists_title[i], pave[i], paveSplitLine[i], hSmooth2Data, hSmooth2TT, hSmooth2QCD, hSmooth2Zp10, hSmooth2Zp20, hSmooth2Zp30, hSmooth2Zp40, legs[i], x_max_scale[i], y_max_scale[i] );
		// }
	}
}
void plotter(TString histname, TString histtitle, TString pave, bool paveSplitLine, TH1D* hData, TH1D * hTT, TH1D* hQCD, TH1D * hZp10, TH1D * hZp20, TH1D * hZp30, TH1D * hZp40, bool legswitch, double x_max_scale, double y_max_scale ){
