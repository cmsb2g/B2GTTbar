...
switch (histo)
{
  ...
  //  return xAxisTitle, minX, maxX, xInfo, yInfoTop, legendLocation [4];
    ...
    case 3 :{
    xAxisTitle = "M_{jet}_{Trimmed}(GeV)";
    minX = 10;
    maxX = 500; 
    ...
    case 4 :{
    xAxisTitle = "M_{jet}_{Pruned}(GeV)";
    minX = 10;
    maxX = 500; 
    xInfo = 0.341; //  location of plot description in normalized coordinates
    yInfoTop = 0.868;
    ...
    case 5 :{
    xAxisTitle = "M_{jet}_{Filtered}(GeV)";
    minX = 10;
    maxX = 500; 
    xInfo = 0.341; //  location of plot description in normalized coordinates
    yInfoTop = 0.868;
    ...
    legendLocation[2] = 0.870536;
    legendLocation[3] = 0.651488;
    cout << "This histo is n_ptAK8 " << endl;
    break;    
    }
    case 0 :{
...
//  @ set the Infile names (.root assumed)
  TString InFile1 = "July9-TTJets-25ns-sel1";  // TT Jets
...
// @ set correct event numbers
  ...
  Double_t n_events1 = 11339232 ; // TTJets                     
  Double_t n_events2 = 24151270 ; // W->l+nu+Jets
  Double_t n_events3 = 2966200 ; // Single top
  Double_t n_events4 = 28825132 ; // Drell Yan
...
//  legend->AddEntry(histo5,"Data", "p");
 ...
 // Name the stacked histogram
  canvas->Print("./Stacked/QualityCuts_25ns_"+CalledHisto+"_"+day+"_"+month+"_"+year+".png");
