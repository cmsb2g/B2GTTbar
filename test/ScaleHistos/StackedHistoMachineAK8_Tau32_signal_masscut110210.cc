...
void callHistos();
void StackedHistoMachineAK8_Tau32_signal_masscut110210();
...
// For./Input/AK8minmass-TTJet_WJetLNu-TTJet-ST.txt - move x below to 0.131 was 0.1 by default 
  ...
  tlx->DrawLatex(0.131, 0.636, "#bf{110 GeV < M_{Groomed} < 210 GeV}"); 

  canvas->Update();

  TLegend *legend=new TLegend(0.100759, 0.310595, 0.470536, 0.601488 ); //0.690759, 0.350595, 0.870536, 0.651488
  canvas->cd(1);
...
//  canvas->Print("./Stacked/"+InFile1+"-"+InFile2+"-"+InFile3+"-"+InFile4+"-"+CalledHisto+"-"+"Min-110-Max-210"+day+"_"+month+"_"+year+".png");
  canvas->Print("./Stacked/nMinus1plots-masscut110to210-"+CalledHisto+"-"+day+"_"+month+"_"+year+".png");
