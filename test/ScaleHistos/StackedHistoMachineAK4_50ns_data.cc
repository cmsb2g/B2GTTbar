...
void callHistos();
void StackedHistoMachineAK4_50ns_data();
...
//  @ set the Infile names (.root assumed)
  ...
  TString InFile3 = "July21-ST-50ns-sel1";  // Single Top
  ...
  TString InFile8 = "July21-JetData-50ns-sel1";  //Jet Data

// Ask about/ try again with ntuplereader_data failing only on Electron data set
...
// @ set correct event numbers
  ...
  Double_t n_events5 =  2814400; //  Mu Data
  Double_t n_events6 = 103854 ; //  Z'-> t tbar 2TeV W = 200
  Double_t n_events7 =  202573 ; //Z'-> t tbar 2TeV W = 20
  Double_t n_events8 =  5206577; //  Jet Data

  Double_t lum = 5.590 ; // total for data as on july 22 according to https://twiki.cern.ch/twiki/bin/view/CMS/B2GAnaFilesRunIISpring15DR74Asympt50ns
...
//  legend->AddEntry(histo5,"Data", "p");
 ...
 // Name the stacked histogram
  canvas->Print("./Stacked/Data_QualityCuts_50ns_"+CalledHisto+"_"+day+"_"+month+"_"+year+".png");
