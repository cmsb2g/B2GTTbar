...
# Direcetory of the trees as of 02/05/16:
# ttbar:   store/user/camclean/B2GAnaFW/Trees/20160203_UpdatedPDF/
# Zprime:  store/user/camclean/B2GAnaFW/Trees/20160203_UpdatedPDF/
# RSGluon: store/user/camclean/B2GAnaFW/Trees/20160204_RSGluonNoPDF/
...
path_data = [
    # data
    "python bkgdEst.py --file=root://cmsxrootd-site.fnal.gov//store/user/jdolen/B2GAnaFW/Trees/JetHT_BothParts_B2GAnaFW_v74x_V8p4_25ns_Nov13silverJSON_reader5a85e65.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_JetHT_BothParts_B2GAnaFW_v74x_V8p4_25ns_Nov13silverJSON_reader5a85e65 --Syst=0 --date="+options.date+" " 
]
...
path_Zprime = [
    ...
    "python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=0  --date="+options.date+" &",
    # ZprimeToTT_M-1250_W-12p5 jecUp
    "python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=+1 --date="+options.date+" &",
    # ZprimeToTT_M-1250_W-12p5 jecDn
    "python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=-1 --date="+options.date+" &",
    # ZprimeToTT_M-1250_W-12p5 jerUp
    "python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=+2 --date="+options.date+" &",
    # ZprimeToTT_M-1250_W-12p5 jerDn
    "python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=-2 --date="+options.date+" &",
    # ZprimeToTT_M-1250_W-12p5 btagUp
    "python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=+3 --date="+options.date+" &",
    # ZprimeToTT_M-1250_W-12p5 btagDn
    "python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=-3 --date="+options.date+" &",
    # ZprimeToTT_M-1250_W-12p5 pdfUp
    "python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=+4 --date="+options.date+" &",
    # ZprimeToTT_M-1250_W-12p5 pdfDn
    "python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=-4 --date="+options.date+" &",
    # ZprimeToTT_M-1250_W-12p5 q2Up
    #"python bkgdEst.py --file="+options.treedir+"tree_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_ZprimeToTT_M-1250_W-12p5_B2Gv8p4_reader603e --Syst=+5 --date="+options.date+" &",
...
path_RSGluon = [
    ...
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=0  --date="+options.date+" &",
    # RSGluonToTT_M-1000 jecUp
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=+1 --date="+options.date+" &",
    # RSGluonToTT_M-1000 jecDn
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=-1 --date="+options.date+" &",
    # RSGluonToTT_M-1000 jerUp
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=+2 --date="+options.date+" &",
    # RSGluonToTT_M-1000 jerDn
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=-2 --date="+options.date+" &",
    # RSGluonToTT_M-1000 btagUp
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=+3 --date="+options.date+" &",
    # RSGluonToTT_M-1000 btagDn
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=-3 --date="+options.date+" &",
    # RSGluonToTT_M-1000 pdfUp
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=+4 --date="+options.date+" &",
    # RSGluonToTT_M-1000 pdfDn
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=-4 --date="+options.date+" &",
    # RSGluonToTT_M-1000 q2Up
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=+5 --date="+options.date+" &",
    # RSGluonToTT_M-1000 q2Dn
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1000_B2Gv8p4_reader603e --Syst=-5 --date="+options.date+" &",


    # RSGluonToTT_M-1250 nom 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=0  --date="+options.date+" &",
    # RSGluonToTT_M-1250 jecUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=+1 --date="+options.date+" &",
    # RSGluonToTT_M-1250 jecDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=-1 --date="+options.date+" &",
    # RSGluonToTT_M-1250 jerUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=+2 --date="+options.date+" &",
    # RSGluonToTT_M-1250 jerDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=-2 --date="+options.date+" &",
    # RSGluonToTT_M-1250 btagUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=+3 --date="+options.date+" &",
    # RSGluonToTT_M-1250 btagDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=-3 --date="+options.date+" &",
    # RSGluonToTT_M-1250 pdfUp 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=+4 --date="+options.date+" &",
    # RSGluonToTT_M-1250 pdfDn
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=-4 --date="+options.date+" &",
    # RSGluonToTT_M-1250 q2Up 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=+5 --date="+options.date+" &",
    # RSGluonToTT_M-1250 q2Dn 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1250_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1250_B2Gv8p4_reader603e --Syst=-5 --date="+options.date+" &",


    # RSGluonToTT_M-1500 nom 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=0  --date="+options.date+" &",
    # RSGluonToTT_M-1500 jecUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=+1 --date="+options.date+" &",
    # RSGluonToTT_M-1500 jecDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=-1 --date="+options.date+" &",
    # RSGluonToTT_M-1500 jerUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=+2 --date="+options.date+" &",
    # RSGluonToTT_M-1500 jerDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=-2 --date="+options.date+" &",
    # RSGluonToTT_M-1500 btagUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=+3 --date="+options.date+" &",
    # RSGluonToTT_M-1500 btagDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=-3 --date="+options.date+" &",
    # RSGluonToTT_M-1500 pdfUp 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=+4 --date="+options.date+" &",
    # RSGluonToTT_M-1500 pdfDn 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=-4 --date="+options.date+" &",
    # RSGluonToTT_M-1500 q2Up 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=+5 --date="+options.date+" &",
    # RSGluonToTT_M-1500 q2Dn 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-1500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-1500_B2Gv8p4_reader603e --Syst=-5 --date="+options.date+" &",


    # RSGluonToTT_M-2000 nom 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=0  --date="+options.date+" &",
    # RSGluonToTT_M-2000 jecUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=+1 --date="+options.date+" &",
    # RSGluonToTT_M-2000 jecDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=-1 --date="+options.date+" &",
    # RSGluonToTT_M-2000 jerUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=+2 --date="+options.date+" &",
    # RSGluonToTT_M-2000 jerDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=-2 --date="+options.date+" &",
    # RSGluonToTT_M-2000 btagUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=+3 --date="+options.date+" &",
    # RSGluonToTT_M-2000 btagDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=-3 --date="+options.date+" &",
    # RSGluonToTT_M-2000 pdfUp 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=+4 --date="+options.date+" &",
    # RSGluonToTT_M-2000 pdfDn 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=-4 --date="+options.date+" &",
    # RSGluonToTT_M-2000 q2Up 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=+5 --date="+options.date+" &",
    # RSGluonToTT_M-2000 q2Dn 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2000_B2Gv8p4_reader603e --Syst=-5 --date="+options.date+" &",


    # RSGluonToTT_M-2500 nom 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=0  --date="+options.date+" &",
    # RSGluonToTT_M-2500 jecUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=+1 --date="+options.date+" &",
    # RSGluonToTT_M-2500 jecDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=-1 --date="+options.date+" &",
    # RSGluonToTT_M-2500 jerUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=+2 --date="+options.date+" &",
    # RSGluonToTT_M-2500 jerDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=-2 --date="+options.date+" &",
    # RSGluonToTT_M-2500 btagUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=+3 --date="+options.date+" &",
    # RSGluonToTT_M-2500 btagDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=-3 --date="+options.date+" &",
    # RSGluonToTT_M-2500 pdfUp 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=+4 --date="+options.date+" &",
    # RSGluonToTT_M-2500 pdfDn 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=-4 --date="+options.date+" &",
    # RSGluonToTT_M-2500 q2Up 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=+5 --date="+options.date+" &",
    # RSGluonToTT_M-2500 q2Dn 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-2500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-2500_B2Gv8p4_reader603e --Syst=-5 --date="+options.date+" &",


    # RSGluonToTT_M-3000 nom 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=0  --date="+options.date+" &",
    # RSGluonToTT_M-3000 jecUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=+1 --date="+options.date+" &",
    # RSGluonToTT_M-3000 jecDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=-1 --date="+options.date+" &",
    # RSGluonToTT_M-3000 jerUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=+2 --date="+options.date+" &",
    # RSGluonToTT_M-3000 jerDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=-2 --date="+options.date+" &",
    # RSGluonToTT_M-3000 btagUp 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=+3 --date="+options.date+" &",
    # RSGluonToTT_M-3000 btagDn 
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=-3 --date="+options.date+" &",
    # RSGluonToTT_M-3000 pdfUp 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=+4 --date="+options.date+" &",
    # RSGluonToTT_M-3000 pdfDn 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=-4 --date="+options.date+" &",
    # RSGluonToTT_M-3000 q2Up 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=+5 --date="+options.date+" &",
    # RSGluonToTT_M-3000 q2Dn 
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3000_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3000_B2Gv8p4_reader603e --Syst=-5 --date="+options.date+" &",


    # RSGluonToTT_M-3500 nom
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=0  --date="+options.date+" &",
    # RSGluonToTT_M-3500 jecUp
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=+1 --date="+options.date+" &",
    # RSGluonToTT_M-3500 jecDn
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=-1 --date="+options.date+" &",
    # RSGluonToTT_M-3500 jerUp
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=+2 --date="+options.date+" &",
    # RSGluonToTT_M-3500 jerDn
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=-2 --date="+options.date+" &",
    # RSGluonToTT_M-3500 btagUp
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=+3 --date="+options.date+" &",
    # RSGluonToTT_M-3500 btagDn
    "python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=-3 --date="+options.date+" &",
    # RSGluonToTT_M-3500 pdfUp
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=+4 --date="+options.date+" &",
    # RSGluonToTT_M-3500 pdfDn
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=-4 --date="+options.date+" &",
    # RSGluonToTT_M-3500 q2Up
    #"python bkgdEst.py --file="+options.treedir+"tree_RSGluonToTT_M-3500_B2Gv8p4_reader603e.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_RSGluonToTT_M-3500_B2Gv8p4_reader603e --Syst=+5 --date="+options.date+" &",
