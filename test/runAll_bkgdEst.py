...
path2 = [
    ...
    # ttbar jerDn
    #"python bkgdEst.py --file=root://cmseos.fnal.gov//store/user/jdolen/B2GAnaFW/Trees/tree_TTpowheg_B2Gv8p4_reader5a85e65_all.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_TTpowheg_B2Gv8p4_reader5a85e65_all --Syst=-2 --date="+options.date+" &",
    # ttbar jecDn
    #"python bkgdEst.py --file=root://cmseos.fnal.gov//store/user/jdolen/B2GAnaFW/Trees/tree_TTpowheg_B2Gv8p4_reader5a85e65_all.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_TTpowheg_B2Gv8p4_reader5a85e65_all --Syst=-1 --date="+options.date+"",    
    # ttbar nom
    #"python bkgdEst.py --file=root://cmseos.fnal.gov//store/user/jdolen/B2GAnaFW/Trees/tree_TTpowheg_B2Gv8p4_reader5a85e65_all.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_TTpowheg_B2Gv8p4_reader5a85e65_all --Syst=0 --date="+options.date+" &",
    # ttbar jecUp
    #"python bkgdEst.py --file=root://cmseos.fnal.gov//store/user/jdolen/B2GAnaFW/Trees/tree_TTpowheg_B2Gv8p4_reader5a85e65_all.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_TTpowheg_B2Gv8p4_reader5a85e65_all --Syst=1 --date="+options.date+" &",
    # ttbar jerUp
    #"python bkgdEst.py --file=root://cmseos.fnal.gov//eos/uscms/store/user/jdolen/B2GAnaFW/Trees/tree_TTpowheg_B2Gv8p4_reader5a85e65_all.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_TTpowheg_B2Gv8p4_reader5a85e65_all --Syst=2 --date="+options.date+""
    # ttbar btagup
    "python bkgdEst.py --file=root://cmseos.fnal.gov//store/user/jdolen/B2GAnaFW/Trees/tree_TTpowheg_B2Gv8p4_reader5a85e65_all.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_TTpowheg_B2Gv8p4_reader5a85e65_all --Syst=3 --date="+options.date+" &",
    # ttbar btagDn
    "python bkgdEst.py --file=root://cmseos.fnal.gov//eos/uscms/store/user/jdolen/B2GAnaFW/Trees/tree_TTpowheg_B2Gv8p4_reader5a85e65_all.root --mistagFile="+options.mistagFile+" --outname=outBkgdEst_TTpowheg_B2Gv8p4_reader5a85e65_all --Syst=-3 --date="+options.date+" &"
