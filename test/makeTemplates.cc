...
int makeTemplates(bool ZPNflag, bool ZPWflag, bool ZPXWflag, bool RSGflag){
	...
	files[names::ZPN20] = files[names::ZPN15];//dir +  "outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_011416_nom.root";
	files[names::ZPN25] = dir +  "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e--Syst=0_011416_nom.root";
	...
	files[names::ZPN20_SCALEUP] = files[names::ZPN15];//dir +  "outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_011416_jec_up.root";
	files[names::ZPN25_SCALEUP] = files[names::ZPN25];//dir +  "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e_011416_jec_up.root";
	...
	files[names::ZPN20_SCALEDN] = files[names::ZPN15];//dir +  "outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_011416_jec_dn.root";
	files[names::ZPN25_SCALEDN] = files[names::ZPN25];//dir +  "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e_011416_jec_dn.root";
	...
	files[names::ZPN20_JERUP] = files[names::ZPN15];//dir +  "outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_011416_jer_up.root";
	files[names::ZPN25_JERUP] = files[names::ZPN25];//dir +  "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e_011416_jer_up.root";
	...
	files[names::ZPN20_JERDN] = files[names::ZPN15];//dir +  "outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_011416_jer_dn.root";
	files[names::ZPN25_JERDN] = files[names::ZPN25];//dir +  "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e_011416_jer_dn.root";
