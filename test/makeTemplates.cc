...
int makeTemplates(bool ZPNflag, bool ZPWflag, bool ZPXWflag, bool RSGflag){
	...
	files[names::ZPN10] = dir +  "outBkgdEst_ZprimeToTT_M-1000_W-10_B2Gv8p4_reader603e_011416_nom.root";
	files[names::ZPN15] = dir +  "outBkgdEst_ZprimeToTT_M-1500_W-15_B2Gv8p4_reader603e_011416_nom.root";
	files[names::ZPN20] =  "/uscms_data/d3/pilot/MINIAOD/CMSSW_7_4_1/src/B2GTTbar/test/outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_012016_nom.root";
	files[names::ZPN25] = dir +  "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e_011516_nom.root";
	files[names::ZPN30] = dir +  "outBkgdEst_ZprimeToTT_M-3000_W-30_B2Gv8p4_reader603e_011416_nom.root";
	files[names::ZPN35] = dir +  "outBkgdEst_ZprimeToTT_M-3500_W-35_B2Gv8p4_reader603e_011416_nom.root";
	files[names::ZPN40] = dir +  "outBkgdEst_ZprimeToTT_M-4000_W-40_B2Gv8p4_reader603e_011416_nom.root";
	files[names::ZPN10_SCALEUP] = dir +  "outBkgdEst_ZprimeToTT_M-1000_W-10_B2Gv8p4_reader603e_011416_jec_up.root";
	files[names::ZPN15_SCALEUP] = dir +  "outBkgdEst_ZprimeToTT_M-1500_W-15_B2Gv8p4_reader603e_011416_jec_up.root";
	files[names::ZPN20_SCALEUP] = "/uscms_data/d3/pilot/MINIAOD/CMSSW_7_4_1/src/B2GTTbar/test/outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_012016_jec_up.root";
	files[names::ZPN25_SCALEUP] = dir + "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e_011516_jec_up.root";
	files[names::ZPN30_SCALEUP] = dir +  "outBkgdEst_ZprimeToTT_M-3000_W-30_B2Gv8p4_reader603e_011416_jec_up.root";
	files[names::ZPN35_SCALEUP] = dir +  "outBkgdEst_ZprimeToTT_M-3500_W-35_B2Gv8p4_reader603e_011416_jec_up.root";
	files[names::ZPN40_SCALEUP] = dir +  "outBkgdEst_ZprimeToTT_M-4000_W-40_B2Gv8p4_reader603e_011416_jec_up.root";
	files[names::ZPN10_SCALEDN] = dir +  "outBkgdEst_ZprimeToTT_M-1000_W-10_B2Gv8p4_reader603e_011416_jec_dn.root";
	files[names::ZPN15_SCALEDN] = dir +  "outBkgdEst_ZprimeToTT_M-1500_W-15_B2Gv8p4_reader603e_011416_jec_dn.root";
	files[names::ZPN20_SCALEDN] = "/uscms_data/d3/pilot/MINIAOD/CMSSW_7_4_1/src/B2GTTbar/test/outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_012016_jec_dn.root";
	files[names::ZPN25_SCALEDN] = dir +  "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e_011516_jec_dn.root";
	files[names::ZPN30_SCALEDN] = dir +  "outBkgdEst_ZprimeToTT_M-3000_W-30_B2Gv8p4_reader603e_011416_jec_dn.root";
	files[names::ZPN35_SCALEDN] = dir +  "outBkgdEst_ZprimeToTT_M-3500_W-35_B2Gv8p4_reader603e_011416_jec_dn.root";
	files[names::ZPN40_SCALEDN] = dir +  "outBkgdEst_ZprimeToTT_M-4000_W-40_B2Gv8p4_reader603e_011416_jec_dn.root";
	files[names::ZPN10_JERUP] = dir +  "outBkgdEst_ZprimeToTT_M-1000_W-10_B2Gv8p4_reader603e_011416_jer_up.root";
	files[names::ZPN15_JERUP] = dir +  "outBkgdEst_ZprimeToTT_M-1500_W-15_B2Gv8p4_reader603e_011416_jer_up.root";
	files[names::ZPN20_JERUP] = "/uscms_data/d3/pilot/MINIAOD/CMSSW_7_4_1/src/B2GTTbar/test/outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_012016_jer_up.root";
	files[names::ZPN25_JERUP] = dir +  "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e_011516_jer_up.root";
	files[names::ZPN30_JERUP] = dir +  "outBkgdEst_ZprimeToTT_M-3000_W-30_B2Gv8p4_reader603e_011416_jer_up.root";
	files[names::ZPN35_JERUP] = dir +  "outBkgdEst_ZprimeToTT_M-3500_W-35_B2Gv8p4_reader603e_011416_jer_up.root";
	files[names::ZPN40_JERUP] = dir +  "outBkgdEst_ZprimeToTT_M-4000_W-40_B2Gv8p4_reader603e_011416_jer_up.root";
	files[names::ZPN10_JERDN] = dir +  "outBkgdEst_ZprimeToTT_M-1000_W-10_B2Gv8p4_reader603e_011416_jer_dn.root";
	files[names::ZPN15_JERDN] = dir +  "outBkgdEst_ZprimeToTT_M-1500_W-15_B2Gv8p4_reader603e_011416_jer_dn.root";
	files[names::ZPN20_JERDN] = "/uscms_data/d3/pilot/MINIAOD/CMSSW_7_4_1/src/B2GTTbar/test/outBkgdEst_ZprimeToTT_M-2000_W-20_B2Gv8p4_reader603e_012016_jer_dn.root";
	files[names::ZPN25_JERDN] = dir +  "outBkgdEst_ZprimeToTT_M-2500_W-25_B2Gv8p4_reader603e_011516_jer_dn.root";
