        ...
        if not Leptonic : 
            ...
            if len(ak8JetsGoodSubjetbDisc) > 0 : # questionable, maybe I'm throwing out otherwise good events by requiring a subjet b disc ?
                if ak8JetsGoodSDropMass[0] > 10 :
                    ...
                    h_yAK8.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                    h_mAK8.Fill( ak8JetsGood[0].M(), FlatWeight )
                    h_mprunedAK8.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                    h_mfilteredAK8.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                    h_mtrimmedAK8.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                    h_mSDropAK8.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                    h_minmassAK8.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                    h_subjetMassAK8.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                    h_subjetBdiscAK8.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                    h_nsjAK8.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                    ...
                    if eleJets :  
                        h_ptAK8el.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8el.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8el.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8el.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8el.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8el.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8el.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8el.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8el.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8el.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8el.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8el.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8el.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4el.Fill( theElJet.Perp() )
                        h_phiAK4el.Fill( theElJet.Phi() )
                        h_etaAK4el.Fill( theElJet.Eta() )
                        h_yAK4el.Fill( theElJet.Rapidity() )
                        h_mAK4el.Fill( theElJet.M() )
                        h_bdiscAK4el.Fill( theElJetBDisc )
                        h_ptEl.Fill(theElectron.Perp())  
                        h_etaEl.Fill(theElectron.Eta())     
                    else :
                        h_ptAK8mu.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8mu.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8mu.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8mu.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8mu.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8mu.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8mu.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8mu.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8mu.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8mu.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8mu.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8mu.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8mu.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4mu.Fill( theMuJet.Perp() )
                        h_phiAK4mu.Fill( theMuJet.Phi() )
                        h_etaAK4mu.Fill( theMuJet.Eta() )
                        h_yAK4mu.Fill( theMuJet.Rapidity() )
                        h_mAK4mu.Fill( theMuJet.M() )
                        h_bdiscAK4mu.Fill( theMuJetBDisc )
                        h_ptMu.Fill(theMuon.Perp())
                        h_etaMu.Fill(theMuon.Eta())
                ...
                if minMass > options.minMassCut:
                    ...
                    h_etaAK8_minMasscut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                    h_phiAK8_minMasscut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                    h_yAK8_minMasscut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                    h_mAK8_minMasscut.Fill( ak8JetsGood[0].M(), FlatWeight )
                    h_mprunedAK8_minMasscut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                    h_mfilteredAK8_minMasscut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                    h_mtrimmedAK8_minMasscut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                    h_mSDropAK8_minMasscut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                    h_minmassAK8_minMasscut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                    h_subjetMassAK8_minMasscut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                    h_subjetBdiscAK8_minMasscut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                    h_nsjAK8_minMasscut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                    ...
                    h_etaLep_minMasscut.Fill(theLepton.Eta()) 
                    if eleJets : 
                        h_ptAK8el_minMasscut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8el_minMasscut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8el_minMasscut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8el_minMasscut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8el_minMasscut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8el_minMasscut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8el_minMasscut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8el_minMasscut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8el_minMasscut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8el_minMasscut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8el_minMasscut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8el_minMasscut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8el_minMasscut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4el_minMasscut.Fill( theElJet.Perp() )
                        h_phiAK4el_minMasscut.Fill( theElJet.Phi() )
                        h_etaAK4el_minMasscut.Fill( theElJet.Eta() )
                        h_yAK4el_minMasscut.Fill( theElJet.Rapidity() )
                        h_mAK4el_minMasscut.Fill( theElJet.M() )
                        h_bdiscAK4el_minMasscut.Fill( theElJetBDisc )
                        h_ptEl_minMasscut.Fill(theElectron.Perp())  
                        h_etaEl_minMasscut.Fill(theElectron.Eta())     
                    else :
                        h_ptAK8mu_minMasscut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8mu_minMasscut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8mu_minMasscut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8mu_minMasscut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8mu_minMasscut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8mu_minMasscut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8mu_minMasscut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8mu_minMasscut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8mu_minMasscut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8mu_minMasscut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8mu_minMasscut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8mu_minMasscut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_ptAK4mu_minMasscut.Fill( theMuJet.Perp() )
                        h_phiAK4mu_minMasscut.Fill( theMuJet.Phi() )
                        h_etaAK4mu_minMasscut.Fill( theMuJet.Eta() )
                        h_yAK4mu_minMasscut.Fill( theMuJet.Rapidity() )
                        h_mAK4mu_minMasscut.Fill( theMuJet.M() )
                        h_bdiscAK4mu_minMasscut.Fill( theMuJetBDisc )
                        h_ptMu_minMasscut.Fill(theMuon.Perp())
                        h_etaMu_minMasscut.Fill(theMuon.Eta())
                ...
                #^ Fill histos between min and max soft drop mass cuts
                    ...
                    h_etaAK8_mSDcut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                    h_phiAK8_mSDcut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                    h_yAK8_mSDcut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                    h_mAK8_mSDcut.Fill( ak8JetsGood[0].M(), FlatWeight )
                    h_mprunedAK8_mSDcut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                    h_mfilteredAK8_mSDcut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                    h_mtrimmedAK8_mSDcut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                    h_mSDropAK8_mSDcut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                    h_minmassAK8_mSDcut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                    h_subjetMassAK8_mSDcut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                    h_subjetBdiscAK8_mSDcut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                    h_nsjAK8_mSDcut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                    h_ptLep_mSDcut.Fill(theLepton.Perp())
                    h_ptAK4_mSDcut.Fill( theLepJet.Perp() )
                    h_mAK4_mSDcut.Fill( theLepJet.M() )
                    h_bdiscAK4_mSDcut.Fill( theLepJetBDisc )
                    h_etaLep_mSDcut.Fill(theLepton.Eta()) 
                    if eleJets :
                        h_ptAK8el_mSDcut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8el_mSDcut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8el_mSDcut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8el_mSDcut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8el_mSDcut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8el_mSDcut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8el_mSDcut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8el_mSDcut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8el_mSDcut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8el_mSDcut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8el_mSDcut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8el_mSDcut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8el_mSDcut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4el_mSDcut.Fill( theElJet.Perp() )
                        h_phiAK4el_mSDcut.Fill( theElJet.Phi() )
                        h_etaAK4el_mSDcut.Fill( theElJet.Eta() )
                        h_yAK4el_mSDcut.Fill( theElJet.Rapidity() )
                        h_mAK4el_mSDcut.Fill( theElJet.M() )
                        h_bdiscAK4el_mSDcut.Fill( theElJetBDisc )
                        h_ptEl_mSDcut.Fill(theElectron.Perp())  
                        h_etaEl_mSDcut.Fill(theElectron.Eta())     
                    else :
                        h_ptAK8mu_mSDcut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8mu_mSDcut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8mu_mSDcut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8mu_mSDcut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8mu_mSDcut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8mu_mSDcut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8mu_mSDcut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8mu_mSDcut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8mu_mSDcut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8mu_mSDcut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8mu_mSDcut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8mu_mSDcut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8mu_mSDcut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4mu_mSDcut.Fill( theMuJet.Perp() )
                        h_phiAK4mu_mSDcut.Fill( theMuJet.Phi() )
                        h_etaAK4mu_mSDcut.Fill( theMuJet.Eta() )
                        h_yAK4mu_mSDcut.Fill( theMuJet.Rapidity() )
                        h_mAK4mu_mSDcut.Fill( theMuJet.M() )
                        h_bdiscAK4mu_mSDcut.Fill( theMuJetBDisc )
                        h_ptMu_mSDcut.Fill(theMuon.Perp())
                        h_etaMu_mSDcut.Fill(theMuon.Eta())
                ...
                #^ Fill histos between min and max soft drop mass cuts and pass min mass pairing cuts
                    ...
                    h_etaAK8_mSDcut_minMasscut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                    h_phiAK8_mSDcut_minMasscut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                    h_yAK8_mSDcut_minMasscut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                    h_mAK8_mSDcut_minMasscut.Fill( ak8JetsGood[0].M(), FlatWeight )
                    h_mprunedAK8_mSDcut_minMasscut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                    h_mfilteredAK8_mSDcut_minMasscut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                    h_mtrimmedAK8_mSDcut_minMasscut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                    h_mSDropAK8_mSDcut_minMasscut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                    h_minmassAK8_mSDcut_minMasscut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                    h_subjetMassAK8_mSDcut_minMasscut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                    h_subjetBdiscAK8_mSDcut_minMasscut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                    h_nsjAK8_mSDcut_minMasscut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                    h_ptLep_mSDcut_minMasscut.Fill(theLepton.Perp())
                    h_ptAK4_mSDcut_minMasscut.Fill( theLepJet.Perp() )
                    h_mAK4_mSDcut_minMasscut.Fill( theLepJet.M() )
                    h_bdiscAK4_mSDcut_minMasscut.Fill( theLepJetBDisc )
                    h_etaLep_mSDcut_minMasscut.Fill(theLepton.Eta()) 
                    if eleJets :
                        h_ptAK8el_mSDcut_minMasscut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8el_mSDcut_minMasscut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8el_mSDcut_minMasscut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8el_mSDcut_minMasscut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8el_mSDcut_minMasscut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8el_mSDcut_minMasscut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8el_mSDcut_minMasscut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8el_mSDcut_minMasscut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8el_mSDcut_minMasscut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8el_mSDcut_minMasscut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8el_mSDcut_minMasscut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8el_mSDcut_minMasscut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8el_mSDcut_minMasscut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4el_mSDcut_minMasscut.Fill( theElJet.Perp() )
                        h_phiAK4el_mSDcut_minMasscut.Fill( theElJet.Phi() )
                        h_etaAK4el_mSDcut_minMasscut.Fill( theElJet.Eta() )
                        h_yAK4el_mSDcut_minMasscut.Fill( theElJet.Rapidity() )
                        h_mAK4el_mSDcut_minMasscut.Fill( theElJet.M() )
                        h_bdiscAK4el_mSDcut_minMasscut.Fill( theElJetBDisc )
                        h_ptEl_mSDcut_minMasscut.Fill(theElectron.Perp())  
                        h_etaEl_mSDcut_minMasscut.Fill(theElectron.Eta())     
                    else :
                        h_ptAK8mu_mSDcut_minMasscut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8mu_mSDcut_minMasscut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8mu_mSDcut_minMasscut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8mu_mSDcut_minMasscut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8mu_mSDcut_minMasscut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8mu_mSDcut_minMasscut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8mu_mSDcut_minMasscut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8mu_mSDcut_minMasscut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8mu_mSDcut_minMasscut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8mu_mSDcut_minMasscut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8mu_mSDcut_minMasscut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8mu_mSDcut_minMasscut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8mu_mSDcut_minMasscut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4mu_mSDcut_minMasscut.Fill( theMuJet.Perp() )
                        h_phiAK4mu_mSDcut_minMasscut.Fill( theMuJet.Phi() )
                        h_etaAK4mu_mSDcut_minMasscut.Fill( theMuJet.Eta() )
                        h_yAK4mu_mSDcut_minMasscut.Fill( theMuJet.Rapidity() )
                        h_mAK4mu_mSDcut_minMasscut.Fill( theMuJet.M() )
                        h_bdiscAK4mu_mSDcut_minMasscut.Fill( theMuJetBDisc )
                        h_ptMu_mSDcut_minMasscut.Fill(theMuon.Perp())
                        h_etaMu_mSDcut_minMasscut.Fill(theMuon.Eta())
                ...
                #^ Fill histos that pass tau32 cut
                    ...
                    h_etaAK8_tau32cut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                    h_phiAK8_tau32cut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                    h_yAK8_tau32cut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                    h_mAK8_tau32cut.Fill( ak8JetsGood[0].M(), FlatWeight )
                    h_mprunedAK8_tau32cut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                    h_mfilteredAK8_tau32cut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                    h_mtrimmedAK8_tau32cut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                    h_mSDropAK8_tau32cut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                    h_minmassAK8_tau32cut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                    h_subjetMassAK8_tau32cut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                    h_subjetBdiscAK8_tau32cut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                    h_nsjAK8_tau32cut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                    h_ptLep_tau32cut.Fill(theLepton.Perp())
                    h_ptAK4_tau32cut.Fill( theLepJet.Perp() )
                    h_mAK4_tau32cut.Fill( theLepJet.M() )
                    h_bdiscAK4_tau32cut.Fill( theLepJetBDisc )
                    h_etaLep_tau32cut.Fill(theLepton.Eta()) 
                    if eleJets :
                        h_ptAK8el_tau32cut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8el_tau32cut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8el_tau32cut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8el_tau32cut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8el_tau32cut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8el_tau32cut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8el_tau32cut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8el_tau32cut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8el_tau32cut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8el_tau32cut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8el_tau32cut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8el_tau32cut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8el_tau32cut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4el_tau32cut.Fill( theElJet.Perp() )
                        h_phiAK4el_tau32cut.Fill( theElJet.Phi() )
                        h_etaAK4el_tau32cut.Fill( theElJet.Eta() )
                        h_yAK4el_tau32cut.Fill( theElJet.Rapidity() )
                        h_mAK4el_tau32cut.Fill( theElJet.M() )
                        h_bdiscAK4el_tau32cut.Fill( theElJetBDisc )
                        h_ptEl_tau32cut.Fill(theElectron.Perp())  
                        h_etaEl_tau32cut.Fill(theElectron.Eta())     
                    else :
                        h_ptAK8mu_tau32cut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8mu_tau32cut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8mu_tau32cut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8mu_tau32cut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8mu_tau32cut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8mu_tau32cut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8mu_tau32cut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8mu_tau32cut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8mu_tau32cut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8mu_tau32cut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8mu_tau32cut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8mu_tau32cut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8mu_tau32cut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4mu_tau32cut.Fill( theMuJet.Perp() )
                        h_phiAK4mu_tau32cut.Fill( theMuJet.Phi() )
                        h_etaAK4mu_tau32cut.Fill( theMuJet.Eta() )
                        h_yAK4mu_tau32cut.Fill( theMuJet.Rapidity() )
                        h_mAK4mu_tau32cut.Fill( theMuJet.M() )
                        h_bdiscAK4mu_tau32cut.Fill( theMuJetBDisc )
                        h_ptMu_tau32cut.Fill(theMuon.Perp())
                ...
                #^ Fill histos with 110 < M_{jet Soft Drop} GeV < 210 (can change default min and max groomed mass cuts in options)
                    ...
                    h_etaAK8_mSDcut_tau32cut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                    h_phiAK8_mSDcut_tau32cut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                    h_yAK8_mSDcut_tau32cut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                    h_mAK8_mSDcut_tau32cut.Fill( ak8JetsGood[0].M(), FlatWeight )
                    h_mprunedAK8_mSDcut_tau32cut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                    h_mfilteredAK8_mSDcut_tau32cut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                    h_mtrimmedAK8_mSDcut_tau32cut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                    h_mSDropAK8_mSDcut_tau32cut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                    h_minmassAK8_mSDcut_tau32cut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                    h_subjetMassAK8_mSDcut_tau32cut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                    h_subjetBdiscAK8_mSDcut_tau32cut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                    h_nsjAK8_mSDcut_tau32cut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                    h_ptLep_mSDcut_tau32cut.Fill(theLepton.Perp())
                    ...
                    h_etaLep_mSDcut_tau32cut.Fill(theLepton.Eta()) 
                    if eleJets :
                        h_ptAK8el_mSDcut_tau32cut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8el_mSDcut_tau32cut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8el_mSDcut_tau32cut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8el_mSDcut_tau32cut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8el_mSDcut_tau32cut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8el_mSDcut_tau32cut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8el_mSDcut_tau32cut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8el_mSDcut_tau32cut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8el_mSDcut_tau32cut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8el_mSDcut_tau32cut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8el_mSDcut_tau32cut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8el_mSDcut_tau32cut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8el_mSDcut_tau32cut.Fill( ak8JetsGoodNSubJets[0], FlatWeight ) 
                        h_ptAK4el_mSDcut_tau32cut.Fill( theElJet.Perp() )
                        h_phiAK4el_mSDcut_tau32cut.Fill( theElJet.Phi() )
                        h_etaAK4el_mSDcut_tau32cut.Fill( theElJet.Eta() )
                        h_yAK4el_mSDcut_tau32cut.Fill( theElJet.Rapidity() )
                        h_mAK4el_mSDcut_tau32cut.Fill( theElJet.M() )
                        h_bdiscAK4el_mSDcut_tau32cut.Fill( theElJetBDisc )
                        h_ptEl_mSDcut_tau32cut.Fill(theElectron.Perp())  
                        h_etaEl_mSDcut_tau32cut.Fill(theElectron.Eta())     
                    else :
                        h_ptAK8mu_mSDcut_tau32cut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8mu_mSDcut_tau32cut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8mu_mSDcut_tau32cut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8mu_mSDcut_tau32cut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8mu_mSDcut_tau32cut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8mu_mSDcut_tau32cut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8mu_mSDcut_tau32cut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8mu_mSDcut_tau32cut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8mu_mSDcut_tau32cut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8mu_mSDcut_tau32cut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8mu_mSDcut_tau32cut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8mu_mSDcut_tau32cut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8mu_mSDcut_tau32cut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4mu_mSDcut_tau32cut.Fill( theMuJet.Perp() )
                        h_phiAK4mu_mSDcut_tau32cut.Fill( theMuJet.Phi() )
                        h_etaAK4mu_mSDcut_tau32cut.Fill( theMuJet.Eta() )
                        h_yAK4mu_mSDcut_tau32cut.Fill( theMuJet.Rapidity() )
                        h_mAK4mu_mSDcut_tau32cut.Fill( theMuJet.M() )
                        h_bdiscAK4mu_mSDcut_tau32cut.Fill( theMuJetBDisc )
                        h_ptMu_mSDcut_tau32cut.Fill(theMuon.Perp())
                ...
                #^ Fill histos that pass tau21 cut
                    ...
                    h_etaAK8_tau21cut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                    h_phiAK8_tau21cut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                    h_yAK8_tau21cut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                    h_mAK8_tau21cut.Fill( ak8JetsGood[0].M(), FlatWeight )
                    h_mprunedAK8_tau21cut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                    h_mfilteredAK8_tau21cut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                    h_mtrimmedAK8_tau21cut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                    h_mSDropAK8_tau21cut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                    h_minmassAK8_tau21cut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                    h_subjetMassAK8_tau21cut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                    h_subjetBdiscAK8_tau21cut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                    h_nsjAK8_tau21cut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                    ...
                    h_etaLep_tau21cut.Fill(theLepton.Eta()) 
                    if eleJets :
                        h_ptAK8el_tau21cut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8el_tau21cut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8el_tau21cut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8el_tau21cut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8el_tau21cut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8el_tau21cut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8el_tau21cut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8el_tau21cut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8el_tau21cut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8el_tau21cut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8el_tau21cut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8el_tau21cut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8el_tau21cut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4el_tau21cut.Fill( theElJet.Perp() )
                        h_phiAK4el_tau21cut.Fill( theElJet.Phi() )
                        h_etaAK4el_tau21cut.Fill( theElJet.Eta() )
                        h_yAK4el_tau21cut.Fill( theElJet.Rapidity() )
                        h_mAK4el_tau21cut.Fill( theElJet.M() )
                        h_bdiscAK4el_tau21cut.Fill( theElJetBDisc )
                        h_ptEl_tau21cut.Fill(theElectron.Perp())  
                        h_etaEl_tau21cut.Fill(theElectron.Eta())     
                    else :
                        h_ptAK8mu_tau21cut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8mu_tau21cut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8mu_tau21cut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8mu_tau21cut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8mu_tau21cut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8mu_tau21cut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8mu_tau21cut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8mu_tau21cut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8mu_tau21cut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8mu_tau21cut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8mu_tau21cut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8mu_tau21cut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8mu_tau21cut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4mu_tau21cut.Fill( theMuJet.Perp() )
                        h_phiAK4mu_tau21cut.Fill( theMuJet.Phi() )
                        h_etaAK4mu_tau21cut.Fill( theMuJet.Eta() )
                        h_yAK4mu_tau21cut.Fill( theMuJet.Rapidity() )
                        h_mAK4mu_tau21cut.Fill( theMuJet.M() )
                        h_bdiscAK4mu_tau21cut.Fill( theMuJetBDisc )
                        h_ptMu_tau21cut.Fill(theMuon.Perp())
                        h_etaMu_tau21cut.Fill(theMuon.Eta())
                if 60 < minMass < 110:
                    ...
                    h_etaAK8_minMasscutWmass.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                    h_phiAK8_minMasscutWmass.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                    h_yAK8_minMasscutWmass.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                    h_mAK8_minMasscutWmass.Fill( ak8JetsGood[0].M(), FlatWeight )
                    h_mprunedAK8_minMasscutWmass.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                    h_mfilteredAK8_minMasscutWmass.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                    h_mtrimmedAK8_minMasscutWmass.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                    h_mSDropAK8_minMasscutWmass.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                    h_minmassAK8_minMasscutWmass.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                    h_subjetMassAK8_minMasscutWmass.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                    h_subjetBdiscAK8_minMasscutWmass.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                    h_nsjAK8_minMasscutWmass.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                    h_ptLep_minMasscutWmass.Fill(theLepton.Perp())
                    h_ptAK4_minMasscutWmass.Fill( theLepJet.Perp() )
                    h_mAK4_minMasscutWmass.Fill( theLepJet.M() )
                    h_bdiscAK4_minMasscutWmass.Fill( theLepJetBDisc )
                    h_etaLep_minMasscutWmass.Fill(theLepton.Eta()) 
                    if eleJets :
                        h_ptAK8el_minMasscutWmass.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8el_minMasscutWmass.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8el_minMasscutWmass.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8el_minMasscutWmass.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8el_minMasscutWmass.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8el_minMasscutWmass.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8el_minMasscutWmass.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8el_minMasscutWmass.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8el_minMasscutWmass.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8el_minMasscutWmass.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8el_minMasscutWmass.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8el_minMasscutWmass.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8el_minMasscutWmass.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4el_minMasscutWmass.Fill( theElJet.Perp() )
                        h_phiAK4el_minMasscutWmass.Fill( theElJet.Phi() )
                        h_etaAK4el_minMasscutWmass.Fill( theElJet.Eta() )
                        h_yAK4el_minMasscutWmass.Fill( theElJet.Rapidity() )
                        h_mAK4el_minMasscutWmass.Fill( theElJet.M() )
                        h_bdiscAK4el_minMasscutWmass.Fill( theElJetBDisc )
                        h_ptEl_minMasscutWmass.Fill(theElectron.Perp())  
                        h_etaEl_minMasscutWmass.Fill(theElectron.Eta())     
                    else :
                        h_ptAK8mu_minMasscutWmass.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8mu_minMasscutWmass.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8mu_minMasscutWmass.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8mu_minMasscutWmass.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8mu_minMasscutWmass.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8mu_minMasscutWmass.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8mu_minMasscutWmass.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8mu_minMasscutWmass.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8mu_minMasscutWmass.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8mu_minMasscutWmass.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8mu_minMasscutWmass.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8mu_minMasscutWmass.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8mu_minMasscutWmass.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4mu_minMasscutWmass.Fill( theMuJet.Perp() )
                        h_phiAK4mu_minMasscutWmass.Fill( theMuJet.Phi() )
                        h_etaAK4mu_minMasscutWmass.Fill( theMuJet.Eta() )
                        h_yAK4mu_minMasscutWmass.Fill( theMuJet.Rapidity() )
                        h_mAK4mu_minMasscutWmass.Fill( theMuJet.M() )
                        h_bdiscAK4mu_minMasscutWmass.Fill( theMuJetBDisc )
                        h_ptMu_minMasscutWmass.Fill(theMuon.Perp())
                        h_etaMu_minMasscutWmass.Fill(theMuon.Eta())
                if theLepJetBDisc < options.bDiscMin:
                    ...
                    h_etaAK8_bDiscMincut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                    h_phiAK8_bDiscMincut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                    h_yAK8_bDiscMincut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                    h_mAK8_bDiscMincut.Fill( ak8JetsGood[0].M(), FlatWeight )
                    h_mprunedAK8_bDiscMincut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                    h_mfilteredAK8_bDiscMincut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                    h_mtrimmedAK8_bDiscMincut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                    h_mSDropAK8_bDiscMincut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                    h_minmassAK8_bDiscMincut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                    h_subjetMassAK8_bDiscMincut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                    h_subjetBdiscAK8_bDiscMincut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                    h_nsjAK8_bDiscMincut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                    h_ptLep_bDiscMincut.Fill(theLepton.Perp())
                    h_ptAK4_bDiscMincut.Fill( theLepJet.Perp() )
                    h_mAK4_bDiscMincut.Fill( theLepJet.M() )
                    h_bdiscAK4_bDiscMincut.Fill( theLepJetBDisc )
                    h_etaLep_bDiscMincut.Fill(theLepton.Eta()) 
                    if eleJets :
                        h_ptAK8el_bDiscMincut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8el_bDiscMincut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8el_bDiscMincut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8el_bDiscMincut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8el_bDiscMincut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8el_bDiscMincut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8el_bDiscMincut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8el_bDiscMincut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8el_bDiscMincut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8el_bDiscMincut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8el_bDiscMincut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8el_bDiscMincut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8el_bDiscMincut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        ...
                        h_ptAK8mu_bDiscMincut.Fill( ak8JetsGood[0].Perp(), FlatWeight )
                        h_etaAK8mu_bDiscMincut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8mu_bDiscMincut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8mu_bDiscMincut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8mu_bDiscMincut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8mu_bDiscMincut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8mu_bDiscMincut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8mu_bDiscMincut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8mu_bDiscMincut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8mu_bDiscMincut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8mu_bDiscMincut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8mu_bDiscMincut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8mu_bDiscMincut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptAK4mu_bDiscMincut.Fill( theMuJet.Perp() )
                        h_phiAK4mu_bDiscMincut.Fill( theMuJet.Phi() )
                        h_etaAK4mu_bDiscMincut.Fill( theMuJet.Eta() )
                        h_yAK4mu_bDiscMincut.Fill( theMuJet.Rapidity() )
                        h_mAK4mu_bDiscMincut.Fill( theMuJet.M() )
                        h_bdiscAK4mu_bDiscMincut.Fill( theMuJetBDisc )
                        h_ptMu_bDiscMincut.Fill(theMuon.Perp())
                ...
                if eleJets :
                    if theElectron.Perp() < options.minElectronPt: 
                        ...
                        h_etaAK8_ptElcut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8_ptElcut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8_ptElcut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8_ptElcut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8_ptElcut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8_ptElcut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8_ptElcut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8_ptElcut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8_ptElcut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8_ptElcut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8_ptElcut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8_ptElcut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptLep_ptElcut.Fill(theLepton.Perp())
                        h_ptAK4_ptElcut.Fill( theLepJet.Perp() )
                        h_mAK4_ptElcut.Fill( theLepJet.M() )
                        h_bdiscAK4_ptElcut.Fill( theLepJetBDisc )
                        h_etaLep_ptElcut.Fill(theLepton.Eta())   
                        h_ptAK4el_ptElcut.Fill( theElJet.Perp() )
                        h_phiAK4el_ptElcut.Fill( theElJet.Phi() )
                        h_etaAK4el_ptElcut.Fill( theElJet.Eta() )
                        h_yAK4el_ptElcut.Fill( theElJet.Rapidity() )
                        h_mAK4el_ptElcut.Fill( theElJet.M() )
                        h_bdiscAK4el_ptElcut.Fill( theElJetBDisc )
                        h_ptEl_ptElcut.Fill(theElectron.Perp())  
                        h_etaEl_ptElcut.Fill(theElectron.Eta())     
                else :
                    if theMuon.Perp() < options.minMuonPt: 
                        ...
                        h_etaAK8_ptMucut.Fill( ak8JetsGood[0].Eta(), FlatWeight )
                        h_phiAK8_ptMucut.Fill( ak8JetsGood[0].Phi(), FlatWeight )
                        h_yAK8_ptMucut.Fill( ak8JetsGood[0].Rapidity(), FlatWeight )
                        h_mAK8_ptMucut.Fill( ak8JetsGood[0].M(), FlatWeight )
                        h_mprunedAK8_ptMucut.Fill( ak8JetsGoodPrunMass[0], FlatWeight )
                        h_mfilteredAK8_ptMucut.Fill( ak8JetsGoodFiltMass[0], FlatWeight )
                        h_mtrimmedAK8_ptMucut.Fill( ak8JetsGoodTrimMass[0], FlatWeight )
                        h_mSDropAK8_ptMucut.Fill( ak8JetsGoodSDropMass[0], FlatWeight )
                        h_minmassAK8_ptMucut.Fill( ak8JetsGoodMinMass[0], FlatWeight )
                        h_subjetMassAK8_ptMucut.Fill( ak8JetsGoodSubjetMass[0], FlatWeight )
                        h_subjetBdiscAK8_ptMucut.Fill( ak8JetsGoodSubjetbDisc[0], FlatWeight )
                        h_nsjAK8_ptMucut.Fill( ak8JetsGoodNSubJets[0], FlatWeight )
                        h_ptLep_ptMucut.Fill(theLepton.Perp())
                        h_ptAK4_ptMucut.Fill( theLepJet.Perp() )
                        h_mAK4_ptMucut.Fill( theLepJet.M() )
                        h_bdiscAK4_ptMucut.Fill( theLepJetBDisc )
                        h_etaLep_ptMucut.Fill(theLepton.Eta())             
                        h_ptAK4mu_ptMucut.Fill( theMuJet.Perp() )
                        h_phiAK4mu_ptMucut.Fill( theMuJet.Phi() )
                        h_etaAK4mu_ptMucut.Fill( theMuJet.Eta() )
                        h_yAK4mu_ptMucut.Fill( theMuJet.Rapidity() )
                        h_mAK4mu_ptMucut.Fill( theMuJet.M() )
                        h_bdiscAK4mu_ptMucut.Fill( theMuJetBDisc )
                        h_ptMu_ptMucut.Fill(theMuon.Perp())
                        h_etaMu_ptMucut.Fill(theMuon.Eta())
