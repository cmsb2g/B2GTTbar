...
class RunSemiLepTTbar() :
    ...
    def __init__(self, argv ) : 
        ...
        ### Here is the semileptonic ttbar selection
        self.ttbarselection = B2GSelectSemiLepTTbar.B2GSelectSemiLepTTbar( options, self.treeobj )
    ...
    def run(self):
        ...
        for jentry in xrange( self.eventsToRun ):
            ...
            passbits = self.ttbarselection.select()
    ...
    def book( self ) :
        ...
        self.hists = []
        for ival in xrange(self.ttbarselection.nstages):
    ...
    def fill( self, index ) :
        ...
        '''        
        if self.ttbarselection.ak8Jet != None :
            a = self.ttbarselection
            self.AK8PtHist[index].Fill( a.ak8Jet.Perp() )
            self.AK8EtaHist[index].Fill( a.ak8Jet.Eta() )
            self.AK8MHist[index].Fill( a.ak8Jet.M() )
            self.AK8MSDHist[index].Fill( a.ak8SDJet.M() )            
