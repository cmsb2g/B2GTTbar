...
class B2GTTreeSemiLep( ) :
    def __init__( self, options ):
        ...
        self.variables = {
            ...
            'AK4_dRminLep_Phi':'f',
            'AK4_dRminLep_Mass':'f',
            'AK4_dRminLep_Bdisc':'f',
            'AK4_dRminLep_dRlep':'f',
            'AK4_dRminLep_dRak8':'f',
            #'AK4BtagdRminBdisc':'f',
            #'AK4BtagdRminLep':'f',
            ...
            'MuMedium':'i',
            'MuIso':'f',
            'Electron_iso_passLoose':'f',
            'Electron_noiso_passLoose':'f',
            'Electron_iso_passMedium':'f',
            'Electron_noiso_passMedium':'f',
            'Electron_iso_passTight':'f',
            'Electron_noiso_passTight':'f',
