...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
      'root://cmsxrootd.fnal.gov////store/mc/RunIISummer16MiniAODv2/RSGluonToTT_M-2500_TuneCUETP8M1_13TeV-pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/70000/3AD70AC8-6BDB-E611-8979-7845C4FC361A.root'
    )
)
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("b2gtreeV5_MC_RSG.root"),
