...
config = config()
config.General.requestName = 'b2gtreeV5_ZJetsToMuMu_Mll40To150_PtHat15_DPS-80X-test'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'run_B2GTTbarTreeMaker_MC_CRAB_ZjetstoMuMu.py'
config.JobType.maxJobRuntimeMin = 2750
config.Data.inputDataset = '/ZJetsToMuMu_Mll40To150_PtHat15_DPS/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
