...
ZprimeB2Ganalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   Handle<vector<float> > h_jetAK8ungroomedMass;
   ...
   iEvent.getByLabel("jetsAK8", "jetAK8Mass", h_jetAK8ungroomedMass );
   ...
   if (h_jetAK8Pt.isValid()){//make sure there are AK8 jets
	 ...
	 if (nAK8pt400eta2p4jets == 0){//first top tag jet candidate
	   ...
	   treeVars["topTagJet1_ungroomedMass"] = (*h_jetAK8ungroomedMass)[i];
	   ...
	   //Lorentz vectors
	   softDropJet1.SetPtEtaPhiM((*h_jetAK8Pt)[i],(*h_jetAK8Eta)[i],(*h_jetAK8Phi)[i],(*h_jetAK8softDropMass)[i]);
	   ungroomedJet1.SetPtEtaPhiM((*h_jetAK8Pt)[i],(*h_jetAK8Eta)[i],(*h_jetAK8Phi)[i],(*h_jetAK8ungroomedMass)[i]);
	   ...
	   treeVars["topTagJet2_ungroomedMass"] = (*h_jetAK8ungroomedMass)[i];
	   ...
	   //Lorentz vectors
	   softDropJet2.SetPtEtaPhiM((*h_jetAK8Pt)[i],(*h_jetAK8Eta)[i],(*h_jetAK8Phi)[i],(*h_jetAK8softDropMass)[i]);
	   ungroomedJet2.SetPtEtaPhiM((*h_jetAK8Pt)[i],(*h_jetAK8Eta)[i],(*h_jetAK8Phi)[i],(*h_jetAK8ungroomedMass)[i]);
