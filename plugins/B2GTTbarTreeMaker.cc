    ...
    jerSFtext_ (iConfig.getParameter<std::string>  ("jerSFtext"))
{
  ...
  TreeAllHad->Branch("JetPtRaw"                             , & JetPtRaw                          ,    "JetPtRaw/F"                               );
  TreeAllHad->Branch("JetEtaRaw"                            , & JetEtaRaw                         ,    "JetEtaRaw/F"                              );
  TreeAllHad->Branch("JetPhiRaw"                            , & JetPhiRaw                         ,    "JetPhiRaw/F"                              );                             
  TreeAllHad->Branch("JetMassRaw"                           , & JetMassRaw                        ,    "JetMassRaw/F"                             );
  TreeAllHad->Branch("JetP"                                 , & JetP                              ,    "JetP/F"                                   );                        
  TreeAllHad->Branch("JetPt"                                , & JetPt                             ,    "JetPt/F"                                  );                         
  TreeAllHad->Branch("JetEta"                               , & JetEta                            ,    "JetEta/F"                                 );                          
  TreeAllHad->Branch("JetPhi"                               , & JetPhi                            ,    "JetPhi/F"                                 );                          
  TreeAllHad->Branch("JetRap"                               , & JetRap                            ,    "JetRap/F"                                 );                          
  TreeAllHad->Branch("JetEnergy"                            , & JetEnergy                         ,    "JetEnergy/F"                              );                             
  TreeAllHad->Branch("JetMass"                              , & JetMass                           ,    "JetMass/F"                                );                           
  TreeAllHad->Branch("JetArea"                              , & JetArea                           ,    "JetArea/F"                                );                           
  TreeAllHad->Branch("JetMassSoftDrop"                      , & JetMassSoftDrop                   ,    "JetMassSoftDrop/F"                        );     
  TreeAllHad->Branch("JetMassSDsumSubjetRaw"                , & JetMassSDsumSubjetRaw             ,    "JetMassSDsumSubjetRaw/F"                  );     
  TreeAllHad->Branch("JetMassSDsumSubjetCorrL23"            , & JetMassSDsumSubjetCorrL23         ,    "JetMassSDsumSubjetCorrL23/F"              );          
  TreeAllHad->Branch("JetMassSDsumSubjetCorrL23Up"          , & JetMassSDsumSubjetCorrL23Up       ,    "JetMassSDsumSubjetCorrL23Up/F"            );            
  TreeAllHad->Branch("JetMassSDsumSubjetCorrL23Dn"          , & JetMassSDsumSubjetCorrL23Dn       ,    "JetMassSDsumSubjetCorrL23Dn/F"            );            
  TreeAllHad->Branch("JetMassSDsumSubjetCorrL123"           , & JetMassSDsumSubjetCorrL123        ,    "JetMassSDsumSubjetCorrL123/F"             );            
  TreeAllHad->Branch("JetMassSDsumSubjetCorrL123Up"         , & JetMassSDsumSubjetCorrL123Up      ,    "JetMassSDsumSubjetCorrL123Up/F"           );              
  TreeAllHad->Branch("JetMassSDsumSubjetCorrL123Dn"         , & JetMassSDsumSubjetCorrL123Dn      ,    "JetMassSDsumSubjetCorrL123Dn/F"           );              
  TreeAllHad->Branch("JetMassSDsumSubjetCorrSmear"          , & JetMassSDsumSubjetCorrSmear       ,    "JetMassSDsumSubjetCorrSmear/F"            );           
  TreeAllHad->Branch("JetMassSDsumSubjetCorrSmearUp"        , & JetMassSDsumSubjetCorrSmearUp     ,    "JetMassSDsumSubjetCorrSmearUp/F"          );             
  TreeAllHad->Branch("JetMassSDsumSubjetCorrSmearDn"        , & JetMassSDsumSubjetCorrSmearDn     ,    "JetMassSDsumSubjetCorrSmearDn/F"          );             
  TreeAllHad->Branch("JetMassPruned"                        , & JetMassPruned                     ,    "JetMassPruned/F"                          );   
  TreeAllHad->Branch("JetTau1"                              , & JetTau1                           ,    "JetTau1/F"                                );                           
  TreeAllHad->Branch("JetTau2"                              , & JetTau2                           ,    "JetTau2/F"                                );                           
  TreeAllHad->Branch("JetTau3"                              , & JetTau3                           ,    "JetTau3/F"                                );                           
  TreeAllHad->Branch("JetTau32"                             , & JetTau32                          ,    "JetTau32/F"                               );                            
  TreeAllHad->Branch("JetTau21"                             , & JetTau21                          ,    "JetTau21/F"                               );                            
  TreeAllHad->Branch("JetSDbdisc0"                          , & JetSDbdisc0                       ,    "JetSDbdisc0/F"                            ); 
  TreeAllHad->Branch("JetSDbdisc1"                          , & JetSDbdisc1                       ,    "JetSDbdisc1/F"                            ); 
  TreeAllHad->Branch("JetSDmaxbdisc"                        , & JetSDmaxbdisc                     ,    "JetSDmaxbdisc/F"                          );   
  TreeAllHad->Branch("JetSDmaxbdiscflavHadron"              , & JetSDmaxbdiscflavHadron           ,    "JetSDmaxbdiscflavHadron/F"                ); 
  TreeAllHad->Branch("JetSDmaxbdiscflavParton"              , & JetSDmaxbdiscflavParton           ,    "JetSDmaxbdiscflavParton/F"                ); 
  TreeAllHad->Branch("JetSDsubjet0pt"                       , & JetSDsubjet0pt                    ,    "JetSDsubjet0pt/F"                         );    
  TreeAllHad->Branch("JetSDsubjet0mass"                     , & JetSDsubjet0mass                  ,    "JetSDsubjet0mass/F"                       );
  TreeAllHad->Branch("JetSDsubjet0eta"                      , & JetSDsubjet0eta                   ,    "JetSDsubjet0eta/F"                        );
  TreeAllHad->Branch("JetSDsubjet0phi"                      , & JetSDsubjet0phi                   ,    "JetSDsubjet0phi/F"                        );
  TreeAllHad->Branch("JetSDsubjet0area"                     , & JetSDsubjet0area                  ,    "JetSDsubjet0area/F"                       );
  TreeAllHad->Branch("JetSDsubjet0flavHadron"               , & JetSDsubjet0flavHadron            ,    "JetSDsubjet0flavHadron/F"                 );
  TreeAllHad->Branch("JetSDsubjet0flavParton"               , & JetSDsubjet0flavParton            ,    "JetSDsubjet0flavParton/F"                 );
  TreeAllHad->Branch("JetSDsubjet0tau1"                     , & JetSDsubjet0tau1                  ,    "JetSDsubjet0tau1/F"                       );
  TreeAllHad->Branch("JetSDsubjet0tau2"                     , & JetSDsubjet0tau2                  ,    "JetSDsubjet0tau2/F"                       );
  TreeAllHad->Branch("JetSDsubjet0tau3"                     , & JetSDsubjet0tau3                  ,    "JetSDsubjet0tau3/F"                       );      
  TreeAllHad->Branch("JetSDsubjet1pt"                       , & JetSDsubjet1pt                    ,    "JetSDsubjet1pt/F"                         );    
  TreeAllHad->Branch("JetSDsubjet1mass"                     , & JetSDsubjet1mass                  ,    "JetSDsubjet1mass/F"                       );
  TreeAllHad->Branch("JetSDsubjet1eta"                      , & JetSDsubjet1eta                   ,    "JetSDsubjet1eta/F"                        );
  TreeAllHad->Branch("JetSDsubjet1phi"                      , & JetSDsubjet1phi                   ,    "JetSDsubjet1phi/F"                        );  
  TreeAllHad->Branch("JetSDsubjet1area"                     , & JetSDsubjet1area                  ,    "JetSDsubjet1area/F"                       );
  TreeAllHad->Branch("JetSDsubjet1flavHadron"               , & JetSDsubjet1flavHadron            ,    "JetSDsubjet1flavHadron/F"                 );
  TreeAllHad->Branch("JetSDsubjet1flavParton"               , & JetSDsubjet1flavParton            ,    "JetSDsubjet1flavParton/F"                 );
  TreeAllHad->Branch("JetSDsubjet1tau1"                     , & JetSDsubjet1tau1                  ,    "JetSDsubjet1tau1/F"                       );
  TreeAllHad->Branch("JetSDsubjet1tau2"                     , & JetSDsubjet1tau2                  ,    "JetSDsubjet1tau2/F"                       );
  TreeAllHad->Branch("JetSDsubjet1tau3"                     , & JetSDsubjet1tau3                  ,    "JetSDsubjet1tau3/F"                       );    
  TreeAllHad->Branch("JetPuppiPt"                           , & JetPuppiPt                        ,    "JetPuppiPt/F"                             );
  TreeAllHad->Branch("JetPuppiEta"                          , & JetPuppiEta                       ,    "JetPuppiEta/F"                            ); 
  TreeAllHad->Branch("JetPuppiPhi"                          , & JetPuppiPhi                       ,    "JetPuppiPhi/F"                            ); 
  TreeAllHad->Branch("JetPuppiMass"                         , & JetPuppiMass                      ,    "JetPuppiMass/F"                           );  
  TreeAllHad->Branch("JetPuppiMassSoftDrop"                 , & JetPuppiMassSoftDrop              ,    "JetPuppiMassSoftDrop/F"                   );    
  TreeAllHad->Branch("JetPuppiMassSDsumSubjetRaw"           , & JetPuppiMassSDsumSubjetRaw        ,    "JetPuppiMassSDsumSubjetRaw/F"             );          
  TreeAllHad->Branch("JetPuppiMassSDsumSubjetCorr"          , & JetPuppiMassSDsumSubjetCorr       ,    "JetPuppiMassSDsumSubjetCorr/F"            );           
  TreeAllHad->Branch("JetPuppiMassSDsumSubjetCorrUp"        , & JetPuppiMassSDsumSubjetCorrUp     ,    "JetPuppiMassSDsumSubjetCorrUp/F"          );             
  TreeAllHad->Branch("JetPuppiMassSDsumSubjetCorrDn"        , & JetPuppiMassSDsumSubjetCorrDn     ,    "JetPuppiMassSDsumSubjetCorrDn/F"          );             
  TreeAllHad->Branch("JetPuppiMassSDsumSubjetCorrSmear"     , & JetPuppiMassSDsumSubjetCorrSmear  ,    "JetPuppiMassSDsumSubjetCorrSmear/F"       );                
  TreeAllHad->Branch("JetPuppiMassSDsumSubjetCorrSmearUp"   , & JetPuppiMassSDsumSubjetCorrSmearUp,    "JetPuppiMassSDsumSubjetCorrSmearUp/F"     );                  
  TreeAllHad->Branch("JetPuppiMassSDsumSubjetCorrSmearDn"   , & JetPuppiMassSDsumSubjetCorrSmearDn,    "JetPuppiMassSDsumSubjetCorrSmearDn/F"     );                  
  TreeAllHad->Branch("JetPuppiTau1"                         , & JetPuppiTau1                      ,    "JetPuppiTau1/F"                           );  
  TreeAllHad->Branch("JetPuppiTau2"                         , & JetPuppiTau2                      ,    "JetPuppiTau2/F"                           );  
  TreeAllHad->Branch("JetPuppiTau3"                         , & JetPuppiTau3                      ,    "JetPuppiTau3/F"                           );  
  TreeAllHad->Branch("JetPuppiTau32"                        , & JetPuppiTau32                     ,    "JetPuppiTau32/F"                          );   
  TreeAllHad->Branch("JetPuppiTau21"                        , & JetPuppiTau21                     ,    "JetPuppiTau21/F"                          );   
  TreeAllHad->Branch("JetPuppiSDbdisc0"                     , & JetPuppiSDbdisc0                  ,    "JetPuppiSDbdisc0/F"                       );
  TreeAllHad->Branch("JetPuppiSDbdisc1"                     , & JetPuppiSDbdisc1                  ,    "JetPuppiSDbdisc1/F"                       );
  TreeAllHad->Branch("JetPuppiSDmaxbdisc"                   , & JetPuppiSDmaxbdisc                ,    "JetPuppiSDmaxbdisc/F"                     );  
  TreeAllHad->Branch("JetPuppiSDmaxbdiscflavHadron"         , & JetPuppiSDmaxbdiscflavHadron      ,    "JetPuppiSDmaxbdiscflavHadron/F"           );      
  TreeAllHad->Branch("JetPuppiSDmaxbdiscflavParton"         , & JetPuppiSDmaxbdiscflavParton      ,    "JetPuppiSDmaxbdiscflavParton/F"           );      

  TreeAllHad->Branch("JetPuppiSDsubjet0pt"                  , & JetPuppiSDsubjet0pt               ,    "JetPuppiSDsubjet0pt/F"                    );    
  TreeAllHad->Branch("JetPuppiSDsubjet0mass"                , & JetPuppiSDsubjet0mass             ,    "JetPuppiSDsubjet0mass/F"                  );
  TreeAllHad->Branch("JetPuppiSDsubjet0eta"                 , & JetPuppiSDsubjet0eta              ,    "JetPuppiSDsubjet0eta/F"                   );
  TreeAllHad->Branch("JetPuppiSDsubjet0phi"                 , & JetPuppiSDsubjet0phi              ,    "JetPuppiSDsubjet0phi/F"                   );
  TreeAllHad->Branch("JetPuppiSDsubjet0area"                , & JetPuppiSDsubjet0area             ,    "JetPuppiSDsubjet0area/F"                  );
  TreeAllHad->Branch("JetPuppiSDsubjet0flavHadron"          , & JetPuppiSDsubjet0flavHadron       ,    "JetPuppiSDsubjet0flavHadron/F"            );
  TreeAllHad->Branch("JetPuppiSDsubjet0flavParton"          , & JetPuppiSDsubjet0flavParton       ,    "JetPuppiSDsubjet0flavParton/F"            );
  TreeAllHad->Branch("JetPuppiSDsubjet0tau1"                , & JetPuppiSDsubjet0tau1             ,    "JetPuppiSDsubjet0tau1/F"                  );
  TreeAllHad->Branch("JetPuppiSDsubjet0tau2"                , & JetPuppiSDsubjet0tau2             ,    "JetPuppiSDsubjet0tau2/F"                  );
  TreeAllHad->Branch("JetPuppiSDsubjet0tau3"                , & JetPuppiSDsubjet0tau3             ,    "JetPuppiSDsubjet0tau3/F"                  );      
  TreeAllHad->Branch("JetPuppiSDsubjet1pt"                  , & JetPuppiSDsubjet1pt               ,    "JetPuppiSDsubjet1pt/F"                    );    
  TreeAllHad->Branch("JetPuppiSDsubjet1mass"                , & JetPuppiSDsubjet1mass             ,    "JetPuppiSDsubjet1mass/F"                  );
  TreeAllHad->Branch("JetPuppiSDsubjet1eta"                 , & JetPuppiSDsubjet1eta              ,    "JetPuppiSDsubjet1eta/F"                   );
  TreeAllHad->Branch("JetPuppiSDsubjet1phi"                 , & JetPuppiSDsubjet1phi              ,    "JetPuppiSDsubjet1phi/F"                   );  
  TreeAllHad->Branch("JetPuppiSDsubjet1area"                , & JetPuppiSDsubjet1area             ,    "JetPuppiSDsubjet1area/F"                  );
  TreeAllHad->Branch("JetPuppiSDsubjet1flavHadron"          , & JetPuppiSDsubjet1flavHadron       ,    "JetPuppiSDsubjet1flavHadron/F"            );
  TreeAllHad->Branch("JetPuppiSDsubjet1flavParton"          , & JetPuppiSDsubjet1flavParton       ,    "JetPuppiSDsubjet1flavParton/F"            );
  TreeAllHad->Branch("JetPuppiSDsubjet1tau1"                , & JetPuppiSDsubjet1tau1             ,    "JetPuppiSDsubjet1tau1/F"                  );
  TreeAllHad->Branch("JetPuppiSDsubjet1tau2"                , & JetPuppiSDsubjet1tau2             ,    "JetPuppiSDsubjet1tau2/F"                  );
  TreeAllHad->Branch("JetPuppiSDsubjet1tau3"                , & JetPuppiSDsubjet1tau3             ,    "JetPuppiSDsubjet1tau3/F"                  );    


  TreeAllHad->Branch("JetCHF"                               , & JetCHF                            ,    "JetCHF/F"                                 );                          
  TreeAllHad->Branch("JetNHF"                               , & JetNHF                            ,    "JetNHF/F"                                 );                          
  TreeAllHad->Branch("JetCM"                                , & JetCM                             ,    "JetCM/F"                                  );                         
  TreeAllHad->Branch("JetNM"                                , & JetNM                             ,    "JetNM/F"                                  );                         
  TreeAllHad->Branch("JetNEF"                               , & JetNEF                            ,    "JetNEF/F"                                 );                          
  TreeAllHad->Branch("JetCEF"                               , & JetCEF                            ,    "JetCEF/F"                                 );                          
  TreeAllHad->Branch("JetMF"                                , & JetMF                             ,    "JetMF/F"                                  );                         
  TreeAllHad->Branch("JetMult"                              , & JetMult                           ,    "JetMult/F"                                );                           
  TreeAllHad->Branch("JetMassCorrFactor"                    , & JetMassCorrFactor                 ,    "JetMassCorrFactor/F"                      ); 
  TreeAllHad->Branch("JetMassCorrFactorUp"                  , & JetMassCorrFactorUp               ,    "JetMassCorrFactorUp/F"                    );   
  TreeAllHad->Branch("JetMassCorrFactorDn"                  , & JetMassCorrFactorDn               ,    "JetMassCorrFactorDn/F"                    );   
  TreeAllHad->Branch("JetCorrFactor"                        , & JetCorrFactor                     ,    "JetCorrFactor/F"                          );   
  TreeAllHad->Branch("JetCorrFactorUp"                      , & JetCorrFactorUp                   ,    "JetCorrFactorUp/F"                        );     
  TreeAllHad->Branch("JetCorrFactorDn"                      , & JetCorrFactorDn                   ,    "JetCorrFactorDn/F"                        );     
  TreeAllHad->Branch("JetPtSmearFactor"                     , & JetPtSmearFactor                  ,    "JetPtSmearFactor/F"                       );
  TreeAllHad->Branch("JetPtSmearFactorUp"                   , & JetPtSmearFactorUp                ,    "JetPtSmearFactorUp/F"                     );  
  TreeAllHad->Branch("JetPtSmearFactorDn"                   , & JetPtSmearFactorDn                ,    "JetPtSmearFactorDn/F"                     );  
  TreeAllHad->Branch("JetPuppiMassCorrFactor"               , & JetPuppiMassCorrFactor            ,    "JetPuppiMassCorrFactor/F"                 );      
  TreeAllHad->Branch("JetPuppiMassCorrFactorUp"             , & JetPuppiMassCorrFactorUp          ,    "JetPuppiMassCorrFactorUp/F"               );        
  TreeAllHad->Branch("JetPuppiMassCorrFactorDn"             , & JetPuppiMassCorrFactorDn          ,    "JetPuppiMassCorrFactorDn/F"               );        
  TreeAllHad->Branch("JetPuppiCorrFactor"                   , & JetPuppiCorrFactor                ,    "JetPuppiCorrFactor/F"                     );  
  TreeAllHad->Branch("JetPuppiCorrFactorUp"                 , & JetPuppiCorrFactorUp              ,    "JetPuppiCorrFactorUp/F"                   );    
  TreeAllHad->Branch("JetPuppiCorrFactorDn"                 , & JetPuppiCorrFactorDn              ,    "JetPuppiCorrFactorDn/F"                   );    
  TreeAllHad->Branch("JetPuppiPtSmearFactor"                , & JetPuppiPtSmearFactor             ,    "JetPuppiPtSmearFactor/F"                  );     
  TreeAllHad->Branch("JetPuppiPtSmearFactorUp"              , & JetPuppiPtSmearFactorUp           ,    "JetPuppiPtSmearFactorUp/F"                );       
  TreeAllHad->Branch("JetPuppiPtSmearFactorDn"              , & JetPuppiPtSmearFactorDn           ,    "JetPuppiPtSmearFactorDn/F"                );       
  TreeAllHad->Branch("JetEtaScaleFactor"                    , & JetEtaScaleFactor                 ,    "JetEtaScaleFactor/F"                      ); 
  TreeAllHad->Branch("JetPhiScaleFactor"                    , & JetPhiScaleFactor                 ,    "JetPhiScaleFactor/F"                      ); 
  TreeAllHad->Branch("JetMatchedGenJetDR"                   , & JetMatchedGenJetDR                ,    "JetMatchedGenJetDR/F"                     );  
  TreeAllHad->Branch("JetMatchedGenJetPt"                   , & JetMatchedGenJetPt                ,    "JetMatchedGenJetPt/F"                     );  
  TreeAllHad->Branch("JetMatchedGenJetMass"                 , & JetMatchedGenJetMass              ,    "JetMatchedGenJetMass/F"                   );  

  TreeAllHad->Branch("JetGenMatched_TopHadronic"            , & JetGenMatched_TopHadronic         ,    "JetGenMatched_TopHadronic/I"              );
  TreeAllHad->Branch("JetGenMatched_TopPt"                  , & JetGenMatched_TopPt               ,    "JetGenMatched_TopPt/F"                    );
  TreeAllHad->Branch("JetGenMatched_TopEta"                 , & JetGenMatched_TopEta              ,    "JetGenMatched_TopEta/F"                   );
  TreeAllHad->Branch("JetGenMatched_TopPhi"                 , & JetGenMatched_TopPhi              ,    "JetGenMatched_TopPhi/F"                   );
  TreeAllHad->Branch("JetGenMatched_TopMass"                , & JetGenMatched_TopMass             ,    "JetGenMatched_TopMass/F"                  );
  TreeAllHad->Branch("JetGenMatched_bPt"                    , & JetGenMatched_bPt                 ,    "JetGenMatched_bPt/F"                      );
  TreeAllHad->Branch("JetGenMatched_WPt"                    , & JetGenMatched_WPt                 ,    "JetGenMatched_WPt/F"                      );
  TreeAllHad->Branch("JetGenMatched_Wd1Pt"                  , & JetGenMatched_Wd1Pt               ,    "JetGenMatched_Wd1Pt/F"                    );
  TreeAllHad->Branch("JetGenMatched_Wd2Pt"                  , & JetGenMatched_Wd2Pt               ,    "JetGenMatched_Wd2Pt/F"                    );
  TreeAllHad->Branch("JetGenMatched_Wd1ID"                  , & JetGenMatched_Wd1ID               ,    "JetGenMatched_Wd1ID/F"                    );
  TreeAllHad->Branch("JetGenMatched_Wd2ID"                  , & JetGenMatched_Wd2ID               ,    "JetGenMatched_Wd2ID/F"                    );
  TreeAllHad->Branch("JetGenMatched_MaxDeltaRPartonTop"     , & JetGenMatched_MaxDeltaRPartonTop  ,    "JetGenMatched_MaxDeltaRPartonTop/F"       );
  TreeAllHad->Branch("JetGenMatched_MaxDeltaRWPartonTop"    , & JetGenMatched_MaxDeltaRWPartonTop ,    "JetGenMatched_MaxDeltaRWPartonTop/F"      );
  TreeAllHad->Branch("JetGenMatched_MaxDeltaRWPartonW"      , & JetGenMatched_MaxDeltaRWPartonW   ,    "JetGenMatched_MaxDeltaRWPartonW/F"        );
  TreeAllHad->Branch("JetGenMatched_DeltaR_t_b"             , & JetGenMatched_DeltaR_t_b          ,    "JetGenMatched_DeltaR_t_b/F"               );
  TreeAllHad->Branch("JetGenMatched_DeltaR_t_W"             , & JetGenMatched_DeltaR_t_W          ,    "JetGenMatched_DeltaR_t_W/F"               );
  TreeAllHad->Branch("JetGenMatched_DeltaR_t_Wd1"           , & JetGenMatched_DeltaR_t_Wd1        ,    "JetGenMatched_DeltaR_t_Wd1/F"             );
  TreeAllHad->Branch("JetGenMatched_DeltaR_t_Wd2"           , & JetGenMatched_DeltaR_t_Wd2        ,    "JetGenMatched_DeltaR_t_Wd2/F"             );
  TreeAllHad->Branch("JetGenMatched_DeltaR_W_b1"            , & JetGenMatched_DeltaR_W_b1         ,    "JetGenMatched_DeltaR_W_b1/F"              );
  TreeAllHad->Branch("JetGenMatched_DeltaR_W_Wd1"           , & JetGenMatched_DeltaR_W_Wd1        ,    "JetGenMatched_DeltaR_W_Wd1/F"             );
  TreeAllHad->Branch("JetGenMatched_DeltaR_W_Wd2"           , & JetGenMatched_DeltaR_W_Wd2        ,    "JetGenMatched_DeltaR_W_Wd2/F"             );
  TreeAllHad->Branch("JetGenMatched_DeltaR_Wd1_Wd2"         , & JetGenMatched_DeltaR_Wd1_Wd2      ,    "JetGenMatched_DeltaR_Wd1_Wd2/F"           );
  TreeAllHad->Branch("JetGenMatched_DeltaR_Wd1_b"           , & JetGenMatched_DeltaR_Wd1_b        ,    "JetGenMatched_DeltaR_Wd1_b/F"             );
  TreeAllHad->Branch("JetGenMatched_DeltaR_Wd2_b"           , & JetGenMatched_DeltaR_Wd2_b        ,    "JetGenMatched_DeltaR_Wd2_b/F"             );
  TreeAllHad->Branch("JetGenMatched_DeltaR_jet_t"           , & JetGenMatched_DeltaR_jet_t        ,    "JetGenMatched_DeltaR_jet_t/F"             );
  TreeAllHad->Branch("JetGenMatched_DeltaR_jet_W"           , & JetGenMatched_DeltaR_jet_W        ,    "JetGenMatched_DeltaR_jet_W/F"             );
  TreeAllHad->Branch("JetGenMatched_DeltaR_jet_b"           , & JetGenMatched_DeltaR_jet_b        ,    "JetGenMatched_DeltaR_jet_b/F"             );
  TreeAllHad->Branch("JetGenMatched_DeltaR_jet_Wd1"         , & JetGenMatched_DeltaR_jet_Wd1      ,    "JetGenMatched_DeltaR_jet_Wd1/F"           );
  TreeAllHad->Branch("JetGenMatched_DeltaR_jet_Wd2"         , & JetGenMatched_DeltaR_jet_Wd2      ,    "JetGenMatched_DeltaR_jet_Wd2/F"           );
  TreeAllHad->Branch("JetGenMatched_DeltaR_pup0_b"          , & JetGenMatched_DeltaR_pup0_b       ,    "JetGenMatched_DeltaR_pup0_b/F"            );
  TreeAllHad->Branch("JetGenMatched_DeltaR_pup0_Wd1"        , & JetGenMatched_DeltaR_pup0_Wd1     ,    "JetGenMatched_DeltaR_pup0_Wd1/F"          );
  TreeAllHad->Branch("JetGenMatched_DeltaR_pup0_Wd2"        , & JetGenMatched_DeltaR_pup0_Wd2     ,    "JetGenMatched_DeltaR_pup0_Wd2/F"          );
  TreeAllHad->Branch("JetGenMatched_DeltaR_pup1_b"          , & JetGenMatched_DeltaR_pup1_b       ,    "JetGenMatched_DeltaR_pup1_b/F"            );
  TreeAllHad->Branch("JetGenMatched_DeltaR_pup1_Wd1"        , & JetGenMatched_DeltaR_pup1_Wd1     ,    "JetGenMatched_DeltaR_pup1_Wd1/F"          );
  TreeAllHad->Branch("JetGenMatched_DeltaR_pup1_Wd2"        , & JetGenMatched_DeltaR_pup1_Wd2     ,    "JetGenMatched_DeltaR_pup1_Wd2/F"          );         
  TreeAllHad->Branch("JetGenMatched_partonPt"               , & JetGenMatched_partonPt            ,    "JetGenMatched_partonPt/F"                 );
  TreeAllHad->Branch("JetGenMatched_partonEta"              , & JetGenMatched_partonEta           ,    "JetGenMatched_partonEta/F"                );
  TreeAllHad->Branch("JetGenMatched_partonPhi"              , & JetGenMatched_partonPhi           ,    "JetGenMatched_partonPhi/F"                );
  TreeAllHad->Branch("JetGenMatched_partonMass"             , & JetGenMatched_partonMass          ,    "JetGenMatched_partonMass/F"               );
  TreeAllHad->Branch("JetGenMatched_partonID"               , & JetGenMatched_partonID            ,    "JetGenMatched_partonID/F"                 );
  TreeAllHad->Branch("JetGenMatched_DeltaRjetParton"        , & JetGenMatched_DeltaRjetParton     ,    "JetGenMatched_DeltaRjetParton/F"          );
...
B2GTTbarTreeMaker::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  for (const pat::Jet &ijet : *AK8MINI) {  
    ...
    if (count_AK8MINI==0){
      ...
      Jet0SDsubjet0pt                        = sub0_P4_L23res.Pt() ;         
      Jet0SDsubjet0mass                      = sub0_P4_L23res.M()  ;  
      Jet0SDsubjet0eta                       = sub0_P4_L23res.Eta() ;
      Jet0SDsubjet0phi                       = sub0_P4_L23res.Phi() ;
      ...
      Jet0SDsubjet1pt                        = sub1_P4_L23res.Pt() ;         
      Jet0SDsubjet1mass                      = sub1_P4_L23res.M()  ;  
      Jet0SDsubjet1eta                       = sub1_P4_L23res.Eta() ;
      Jet0SDsubjet1phi                       = sub1_P4_L23res.Phi() ;
      ...
      Jet0PuppiSDsubjet0pt                   = pup0_P4_L23res.Pt() ;         
      Jet0PuppiSDsubjet0mass                 = pup0_P4_L23res.M()  ;  
      Jet0PuppiSDsubjet0eta                  = pup0_P4_L23res.Eta() ;
      Jet0PuppiSDsubjet0phi                  = pup0_P4_L23res.Phi() ;
      Jet0PuppiSDsubjet0area                 = pup0_area ;      
      Jet0PuppiSDsubjet0flavHadron           = pup0_flav_hadron ;  
      Jet0PuppiSDsubjet0flavParton           = pup0_flav_parton ;
      ...
      Jet0PuppiSDsubjet1pt                   = pup1_P4_L23res.Pt() ;         
      Jet0PuppiSDsubjet1mass                 = pup1_P4_L23res.M()  ;  
      Jet0PuppiSDsubjet1eta                  = pup1_P4_L23res.Eta() ;
      Jet0PuppiSDsubjet1phi                  = pup1_P4_L23res.Phi() ;
      Jet0PuppiSDsubjet1area                 = pup1_area ;      
      Jet0PuppiSDsubjet1flavHadron           = pup1_flav_hadron ;  
      Jet0PuppiSDsubjet1flavParton           = pup1_flav_parton ;
    ...
    if (count_AK8MINI==1){
      ...
      Jet1SDsubjet0pt                        = sub0_P4_L23res.Pt() ;         
      Jet1SDsubjet0mass                      = sub0_P4_L23res.M()  ;  
      Jet1SDsubjet0eta                       = sub0_P4_L23res.Eta() ;
      Jet1SDsubjet0phi                       = sub0_P4_L23res.Phi() ;
      ...
      Jet1SDsubjet1pt                        = sub1_P4_L23res.Pt() ;         
      Jet1SDsubjet1mass                      = sub1_P4_L23res.M()  ;  
      Jet1SDsubjet1eta                       = sub1_P4_L23res.Eta() ;
      Jet1SDsubjet1phi                       = sub1_P4_L23res.Phi() ;
      ...
      Jet1PuppiSDsubjet0pt                   = pup0_P4_L23res.Pt() ;         
      Jet1PuppiSDsubjet0mass                 = pup0_P4_L23res.M()  ;  
      Jet1PuppiSDsubjet0eta                  = pup0_P4_L23res.Eta() ;
      Jet1PuppiSDsubjet0phi                  = pup0_P4_L23res.Phi() ;
      ...
      Jet1PuppiSDsubjet1pt                   = pup1_P4_L23res.Pt() ;         
      Jet1PuppiSDsubjet1mass                 = pup1_P4_L23res.M()  ;  
      Jet1PuppiSDsubjet1eta                  = pup1_P4_L23res.Eta() ;
      Jet1PuppiSDsubjet1phi                  = pup1_P4_L23res.Phi() ;
    ...
    if ( ((count_AK8MINI==0&&deltaPhi_lep_jet >=3.14/2) || (count_AK8MINI==1&&deltaPhi_lep_jet >=3.14/2)) && count_mu >=1 && fill_leptTree==0 ){
      ...
      JetSDsubjet0pt                        = sub0_P4_L23res.Pt() ;         
      JetSDsubjet0mass                      = sub0_P4_L23res.M()  ;  
      JetSDsubjet0eta                       = sub0_P4_L23res.Eta() ;
      JetSDsubjet0phi                       = sub0_P4_L23res.Phi() ;
      ...
      JetSDsubjet1pt                        = sub1_P4_L23res.Pt() ;         
      JetSDsubjet1mass                      = sub1_P4_L23res.M()  ;  
      JetSDsubjet1eta                       = sub1_P4_L23res.Eta() ;
      JetSDsubjet1phi                       = sub1_P4_L23res.Phi() ;
      ...
      JetPuppiSDsubjet0pt                   = pup0_P4_L23res.Pt()        ;
      JetPuppiSDsubjet0mass                 = pup0_P4_L23res.M()         ;
      JetPuppiSDsubjet0eta                  = pup0_P4_L23res.Eta()         ;
      JetPuppiSDsubjet0phi                  = pup0_P4_L23res.Phi()         ;      
      JetPuppiSDsubjet0area                 = pup0_area        ;
      JetPuppiSDsubjet0flavHadron           = pup0_flav_hadron        ;
      JetPuppiSDsubjet0flavParton           = pup0_flav_parton        ;
      JetPuppiSDsubjet1pt                   = pup1_P4_L23res.Pt()        ;
      JetPuppiSDsubjet1mass                 = pup1_P4_L23res.M()         ;
      JetPuppiSDsubjet1eta                  = pup1_P4_L23res.Eta()         ;
      JetPuppiSDsubjet1phi                  = pup1_P4_L23res.Phi()         ;      
